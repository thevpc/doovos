 ...
 * jnt.Bench.Bench
 * insertEntry([D)V
 * [count=5] [8] ICONST_0(Integer{0}) [9] ISTORE(2) [10] ALOAD(0) [11] GETFIELD(jnt.Bench.Bench,entries,Ljava/util/Vector;) [12] INVOKEVIRTUAL(java.util.Vector,size()I)
 */
public final class insertEntry_005 extends JJITAbstractInstruction implements Cloneable{
