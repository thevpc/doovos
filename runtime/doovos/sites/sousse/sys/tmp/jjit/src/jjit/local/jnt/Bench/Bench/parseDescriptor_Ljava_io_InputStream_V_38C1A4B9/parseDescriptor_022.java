 ...
 * [count=5] [59] ALOAD(0) [60] ALOAD(0) [61] ALOAD(2) [62] LDC(44->"submission_email") [63] INVOKEVIRTUAL(jnt.Bench.Bench,parseString(Ljava/io/StreamTokenizer;Ljava/lang/String;)Ljava/lang/String;)
 */
public final class parseDescriptor_022 extends JJITAbstractInstruction implements Cloneable{
      private static KReference R44 = null;
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        frame.push(this_ref);
         ...
         // *********[62] LDC(44->"submission_email")
         // **REMOVED Substitution** s2_ref = R44;
         // *********[63] INVOKEVIRTUAL(jnt.Bench.Bench,parseString(Ljava/io/StreamTokenizer;Ljava/lang/String;)Ljava/lang/String;)
