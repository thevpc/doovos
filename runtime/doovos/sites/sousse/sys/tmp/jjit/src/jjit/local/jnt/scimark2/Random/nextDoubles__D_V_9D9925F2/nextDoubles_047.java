 ...
 * jnt.scimark2.Random
 * nextDoubles([D)V
 * [count=9] [299] ALOAD(0) [300] GETFIELD(jnt.scimark2.Random,m,[I) [301] ALOAD(0) [302] GETFIELD(jnt.scimark2.Random,j,I) [303] ILOAD(6) [304] IASTORE [305] ALOAD(0) [306] GETFIELD(jnt.scimark2.Random,j,I) [307] IFNE(312)
 */
public final class nextDoubles_047 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        c_memman.setIntArray(c_m.getInstanceRef(this_ref),c_j.getInstanceInt(this_ref),frame.getLocal(6).intValue());
         // *********[305] ALOAD(0)
         // **REMOVED Substitution** s0_ref = this_ref;
         // *********[306] GETFIELD(jnt.scimark2.Random,j,I)
