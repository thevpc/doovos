 ...
 * [count=4] [168] ALOAD(0) [169] ALOAD(0) [170] GETFIELD(jnt.Bench.SubmitDialog,from,Ljava/awt/TextComponent;) [171] INVOKEVIRTUAL(java.awt.TextComponent,getText()Ljava/lang/String;)
 */
public final class constructBody_079 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        frame.push(this_ref);
         ...
         // *********[170] GETFIELD(jnt.Bench.SubmitDialog,from,Ljava/awt/TextComponent;)
         // **REMOVED Substitution** s0_ref = c_from.getInstanceRef(this_ref);
         // *********[171] INVOKEVIRTUAL(java.awt.TextComponent,getText()Ljava/lang/String;)
        regs = new KRegister[1];
        ref = c_from.getInstanceRef(this_ref);
        regs[0] = ref;
