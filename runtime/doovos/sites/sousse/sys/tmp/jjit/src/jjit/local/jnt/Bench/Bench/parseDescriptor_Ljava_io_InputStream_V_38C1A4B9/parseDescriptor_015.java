 ...
 * [count=2] [42] PUTFIELD(jnt.Bench.Bench,name) [43] GOTO(128)
 */
public final class parseDescriptor_015 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KRegister reg;
         // *********[42] PUTFIELD(jnt.Bench.Bench,name)
        reg = frame.pop();
         // **REMOVED Substitution** ref = frame.popRef();
        c_name.setInstanceValue(frame.popRef(),reg);
         // *********[43] GOTO(128)
        return c_label;
      }
