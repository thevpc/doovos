package jjit.local.jnt.scimark2.Random._init___V_4F8E0498;
 ...
 * jnt.scimark2.Random
 * <init>()V
 * [count=40] [2] ALOAD(0) [3] ICONST_0(Integer{0}) [4] PUTFIELD(jnt.scimark2.Random,seed) [5] ALOAD(0) [6] ICONST_4(Integer{4}) [7] PUTFIELD(jnt.scimark2.Random,i) [8] ALOAD(0) [9] BIPUSH(16) [10] PUTFIELD(jnt.scimark2.Random,j) [11] ALOAD(0) [12] BIPUSH(32) [13] PUTFIELD(jnt.scimark2.Random,mdig) [14] ALOAD(0) [15] ICONST_1(Integer{1}) [16] PUTFIELD(jnt.scimark2.Random,one) [17] ALOAD(0) [18] LDC(9->"2147483647") [19] PUTFIELD(jnt.scimark2.Random,m1) [20] ALOAD(0) [21] LDC(11->"65536") [22] PUTFIELD(jnt.scimark2.Random,m2) [23] ALOAD(0) [24] LDC(13->"4.656612875245797E-10") [25] PUTFIELD(jnt.scimark2.Random,dm1) [26] ALOAD(0) [27] ICONST_0(Integer{0}) [28] PUTFIELD(jnt.scimark2.Random,haveRange) [29] ALOAD(0) [30] DCONST_0(Double{0.0}) [31] PUTFIELD(jnt.scimark2.Random,left) [32] ALOAD(0) [33] DCONST_1(Double{1.0}) [34] PUTFIELD(jnt.scimark2.Random,right) [35] ALOAD(0) [36] DCONST_1(Double{1.0}) [37] PUTFIELD(jnt.scimark2.Random,width) [38] ALOAD(0) [39] INVOKE_HOST(java.lang.System.currentTimeMillis()J) [40] L2I [41] INVOKESPECIAL(jnt.scimark2.Random,initialize(I)V)
 */
public final class _init__004 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        c_width.setInstanceValue(this_ref,DONE);
         // *********[38] ALOAD(0)
         // **REMOVED Substitution** s0_ref = this_ref;
         // *********[39] INVOKE_HOST(java.lang.System.currentTimeMillis()J)
         // **REMOVED Substitution** s1 = new KLong(System.currentTimeMillis());
         // *********[40] L2I
         // **REMOVED Substitution** s1 = new KInteger(((int)System.currentTimeMillis()));
         // *********[41] INVOKESPECIAL(jnt.scimark2.Random,initialize(I)V)
        regs = new KRegister[2];
        regs[1] = new KInteger(((int)System.currentTimeMillis()));
         // **REMOVED Substitution** ref = this_ref;
        regs[0] = this_ref;
        if(m_mth_ignorable){
          nextInstr = c_next;
