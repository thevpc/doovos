 ...
 * [count=5] [8] ALOAD(1) [9] GETFIELD(java.awt.Event,target,Ljava/lang/Object;) [10] ALOAD(0) [11] GETFIELD(jnt.Bench.SubmitDialog,cancel,Ljava/awt/Button;) [12] IF_ACMPNE(16)
 */
public final class handleEvent_005 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KReference ref2;
         ...
         // *********[9] GETFIELD(java.awt.Event,target,Ljava/lang/Object;)
        if(c_target == null){
         ...
         // *********[11] GETFIELD(jnt.Bench.SubmitDialog,cancel,Ljava/awt/Button;)
         // **REMOVED Substitution** s1_ref = c_cancel.getInstanceRef(((KReference)frame.getLocal(0)));
         // *********[12] IF_ACMPNE(16)
        ref = c_cancel.getInstanceRef(((KReference)frame.getLocal(0)));
