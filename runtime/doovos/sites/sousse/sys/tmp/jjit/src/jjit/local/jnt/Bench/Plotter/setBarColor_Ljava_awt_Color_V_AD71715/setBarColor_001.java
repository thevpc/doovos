package jjit.local.jnt.Bench.Plotter.setBarColor_Ljava_awt_Color_V_AD71715;
 ...
 * [count=4] [0] ALOAD(0) [1] ALOAD(1) [2] PUTFIELD(jnt.Bench.Plotter,barColor) [3] RETURN
 */
public final class setBarColor_001 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[2] PUTFIELD(jnt.Bench.Plotter,barColor)
         // **REMOVED Substitution** reg = frame.getLocal(1);
         // **REMOVED Substitution** ref = ((KReference)frame.getLocal(0));
        c_barColor.setInstanceValue(((KReference)frame.getLocal(0)),frame.getLocal(1));
         // *********[3] RETURN
