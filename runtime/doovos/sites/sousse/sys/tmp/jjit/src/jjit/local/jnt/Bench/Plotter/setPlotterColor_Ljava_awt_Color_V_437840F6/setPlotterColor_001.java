package jjit.local.jnt.Bench.Plotter.setPlotterColor_Ljava_awt_Color_V_437840F6;
...
/**
 * jnt.Bench.Plotter
 * setPlotterColor(Ljava/awt/Color;)V
 * [count=4] [0] ALOAD(0) [1] ALOAD(1) [2] PUTFIELD(jnt.Bench.Plotter,bgColor) [3] RETURN
 */
public final class setPlotterColor_001 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[2] PUTFIELD(jnt.Bench.Plotter,bgColor)
         // **REMOVED Substitution** reg = frame.getLocal(1);
         // **REMOVED Substitution** ref = ((KReference)frame.getLocal(0));
        c_bgColor.setInstanceValue(((KReference)frame.getLocal(0)),frame.getLocal(1));
         // *********[3] RETURN
