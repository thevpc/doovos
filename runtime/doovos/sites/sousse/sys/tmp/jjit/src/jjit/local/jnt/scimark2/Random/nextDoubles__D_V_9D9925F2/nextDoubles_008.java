 ...
 * jnt.scimark2.Random
 * nextDoubles([D)V
 * [count=9] [44] ALOAD(0) [45] GETFIELD(jnt.scimark2.Random,m,[I) [46] ALOAD(0) [47] GETFIELD(jnt.scimark2.Random,j,I) [48] ILOAD(5) [49] IASTORE [50] ALOAD(0) [51] GETFIELD(jnt.scimark2.Random,j,I) [52] IFNE(57)
 */
public final class nextDoubles_008 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        c_memman.setIntArray(c_m.getInstanceRef(this_ref),c_j.getInstanceInt(this_ref),frame.getLocal(5).intValue());
         // *********[50] ALOAD(0)
         // **REMOVED Substitution** s0_ref = this_ref;
         // *********[51] GETFIELD(jnt.scimark2.Random,j,I)
