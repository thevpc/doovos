 ...
 * [count=3] [122] ALOAD(8) [123] SIPUSH(Integer{251}) [124] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
 */
public final class send_068 extends JJITAbstractInstruction implements Cloneable{
      private static final KInteger I251 = new KInteger(251);
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[123] SIPUSH(Integer{251})
         // **REMOVED Substitution** s1 = I251;
         // *********[124] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
