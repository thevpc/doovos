 ...
 * doCheck()Z
 * [count=2] [4] ALOAD(0) [5] GETFIELD(jnt.Bench.SubmitDialog,from,Ljava/awt/TextComponent;)
 */
public final class doCheck_004 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
         ...
         // *********[5] GETFIELD(jnt.Bench.SubmitDialog,from,Ljava/awt/TextComponent;)
