 ...
 * [count=2] [308] LDC(59->"os.version: ") [309] INVOKEVIRTUAL(java.lang.StringBuffer,append(Ljava/lang/String;)Ljava/lang/StringBuffer;)
 */
public final class main_118 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KReference ref;
         ...
         // *********[308] LDC(59->"os.version: ")
         // **REMOVED Substitution** s0_ref = R59;
         // *********[309] INVOKEVIRTUAL(java.lang.StringBuffer,append(Ljava/lang/String;)Ljava/lang/StringBuffer;)
        regs = new KRegister[2];
        regs[1] = R59;
        ref = frame.popRef();
        regs[0] = ref;
        frame.setProgramCounter(118);
