 ...
 * [count=9] [8] ALOAD(1) [9] ILOAD(2) [10] ALOAD(0) [11] GETFIELD(jnt.Bench.Bench,segments,[Ljnt/Bench/Segment;) [12] ILOAD(2) [13] AALOAD [14] GETFIELD(jnt.Bench.Segment,units,Ljava/lang/String;) [15] AASTORE [16] IINC(2,1)
 */
public final class getSegmentUnits_004 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        int local_2 = frame.getLocal(2).intValue();
         ...
         // *********[14] GETFIELD(jnt.Bench.Segment,units,Ljava/lang/String;)
        if(c_units == null){
          c_units = c_repo.getClassByName("jnt.Bench.Segment").getField("units",true);
        }
         // **REMOVED Substitution** s2 = c_units.getInstanceValue(c_memman.getReferenceArray(c_segments.getInstanceRef(((KReference)frame.getLocal(0))),local_2));
         // *********[15] AASTORE
         // **REMOVED Substitution** m_r = ((KReference)c_units.getInstanceValue(c_memman.getReferenceArray(c_segments.getInstanceRef(((KReference)frame.getLocal(0))),local_2)));
         // **REMOVED Substitution** index = local_2;
        c_memman.setReferenceArray(((KReference)frame.getLocal(1)),local_2,((KReference)c_units.getInstanceValue(c_memman.getReferenceArray(c_segments.getInstanceRef(((KReference)frame.getLocal(0))),local_2))));
         // *********[16] IINC(2,1)
