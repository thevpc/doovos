 ...
 * [count=3] [157] ALOAD(8) [158] SIPUSH(Integer{221}) [159] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
 */
public final class send_083 extends JJITAbstractInstruction implements Cloneable{
      private static final KInteger I221 = new KInteger(221);
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[158] SIPUSH(Integer{221})
         // **REMOVED Substitution** s1 = I221;
         // *********[159] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
