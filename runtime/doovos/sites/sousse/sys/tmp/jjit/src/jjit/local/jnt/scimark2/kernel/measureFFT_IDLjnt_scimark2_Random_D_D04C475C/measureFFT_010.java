 ...
 * [count=2] [23] ALOAD(4) [24] INVOKESTATIC(jnt.scimark2.FFT,inverse([D)V)
 */
public final class measureFFT_010 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[24] INVOKESTATIC(jnt.scimark2.FFT,inverse([D)V)
