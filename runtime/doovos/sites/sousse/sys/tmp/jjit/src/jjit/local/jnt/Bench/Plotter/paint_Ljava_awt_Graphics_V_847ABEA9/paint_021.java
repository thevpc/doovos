 ...
 * [count=5] [69] ALOAD(0) [70] GETFIELD(jnt.Bench.Plotter,values,[D) [71] ILOAD(13) [72] DALOAD [73] DSTORE(9)
 */
public final class paint_021 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
         ...
         // *********[70] GETFIELD(jnt.Bench.Plotter,values,[D)
         ...
         // *********[73] DSTORE(9)
        frame.setLocal(9,new KDouble(c_memman.getDoubleArray(c_values.getInstanceRef(((KReference)frame.getLocal(0))),frame.getLocal(13).intValue())));
        return c_next;
      }
