 ...
 * [count=5] [81] ALOAD(1) [82] GETFIELD(java.awt.Event,target,Ljava/lang/Object;) [83] ALOAD(0) [84] GETFIELD(jnt.Bench.Applet,table,Ljava/awt/List;) [85] IF_ACMPNE(101)
 */
public final class handleEvent_032 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KReference ref2;
         ...
         // *********[82] GETFIELD(java.awt.Event,target,Ljava/lang/Object;)
        if(c_target == null){
         ...
         // *********[84] GETFIELD(jnt.Bench.Applet,table,Ljava/awt/List;)
         // **REMOVED Substitution** s1_ref = c_table.getInstanceRef(((KReference)frame.getLocal(0)));
         // *********[85] IF_ACMPNE(101)
