 ...
 * [count=3] [92] ALOAD(0) [93] GETFIELD(jnt.Bench.Applet,table,Ljava/awt/List;) [94] ILOAD(2)
 */
public final class handleEvent_037 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
         ...
         // *********[93] GETFIELD(jnt.Bench.Applet,table,Ljava/awt/List;)
