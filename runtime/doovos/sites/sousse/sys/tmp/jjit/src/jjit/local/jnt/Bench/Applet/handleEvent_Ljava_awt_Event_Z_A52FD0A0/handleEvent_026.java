 ...
 * [count=3] [68] ALOAD(0) [69] GETFIELD(jnt.Bench.Applet,status,Ljava/awt/Label;) [70] LDC(34->"")
 */
public final class handleEvent_026 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
         ...
         // *********[69] GETFIELD(jnt.Bench.Applet,status,Ljava/awt/Label;)
