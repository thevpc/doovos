 ...
 * jnt.Bench.Applet
 * startBenchmark()V
 * [count=3] [0] ALOAD(0) [1] GETFIELD(jnt.Bench.Applet,thread,Ljava/lang/Thread;) [2] IFNONNULL(26)
 */
public final class startBenchmark_001 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
         ...
         // *********[2] IFNONNULL(26)
        return ((c_thread.getInstanceRef(((KReference)frame.getLocal(0))).isNotNull())?(c_label):(c_next));
      }
