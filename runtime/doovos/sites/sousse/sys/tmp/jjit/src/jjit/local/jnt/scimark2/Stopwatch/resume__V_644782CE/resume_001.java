 ...
 * resume()V
 * [count=3] [0] ALOAD(0) [1] GETFIELD(jnt.scimark2.Stopwatch,running,Z) [2] IFNE(9)
 */
public final class resume_001 extends JJITAbstractInstruction implements Cloneable{
