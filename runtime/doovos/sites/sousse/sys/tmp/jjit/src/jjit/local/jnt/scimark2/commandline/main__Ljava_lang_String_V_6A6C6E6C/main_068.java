 ...
 * [count=4] [201] ALOAD(8) [202] ICONST_3(Integer{3}) [203] DALOAD [204] INVOKEVIRTUAL(java.lang.StringBuffer,append(D)Ljava/lang/StringBuffer;)
 */
public final class main_068 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KReference ref;
         ...
         // *********[202] ICONST_3(Integer{3})
         // **REMOVED Substitution** s1 = ITHREE;
         // *********[203] DALOAD
         // **REMOVED Substitution** index = 3;
         // **REMOVED Substitution** s0 = new KDouble(c_memman.getDoubleArray(((KReference)frame.getLocal(8)),3));
         // *********[204] INVOKEVIRTUAL(java.lang.StringBuffer,append(D)Ljava/lang/StringBuffer;)
        regs = new KRegister[2];
        regs[1] = new KDouble(c_memman.getDoubleArray(((KReference)frame.getLocal(8)),3));
        ref = frame.popRef();
        regs[0] = ref;
        frame.setProgramCounter(68);
