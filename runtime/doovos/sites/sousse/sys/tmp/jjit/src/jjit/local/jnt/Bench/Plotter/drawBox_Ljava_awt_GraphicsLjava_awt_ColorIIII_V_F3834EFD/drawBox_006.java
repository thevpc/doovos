 ...
 * [count=6] [13] ALOAD(1) [14] ILOAD(3) [15] ILOAD(4) [16] ILOAD(5) [17] ILOAD(6) [18] INVOKEVIRTUAL(java.awt.Graphics,drawRect(IIII)V)
 */
public final class drawBox_006 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KReference ref;
         ...
         // *********[18] INVOKEVIRTUAL(java.awt.Graphics,drawRect(IIII)V)
        ...
        frame.setProgramCounter(6);
         // **REMOVED Substitution** nextFrame = thread.pushFrame(c_memman.getKClass(ref).getVirtualMethodBySignature("drawRect(IIII)V"),regs);
        return ((JJITInstruction)thread.pushFrame(c_memman.getKClass(ref).getVirtualMethodBySignature("drawRect(IIII)V"),regs).getCurrentInstruction());
      }
