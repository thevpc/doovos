 ...
 * [count=3] [109] ALOAD(8) [110] SIPUSH(Integer{250}) [111] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
 */
public final class send_062 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[110] SIPUSH(Integer{250})
         // **REMOVED Substitution** s1 = I250;
         // *********[111] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
