 ...
 * jnt.Bench.Applet
 * init()V
 * [count=4] [255] ALOAD(0) [256] GETFIELD(jnt.Bench.Applet,abortButton,Ljava/awt/Button;) [257] ALOAD(1) [258] INVOKEVIRTUAL(java.awt.Component,setBackground(Ljava/awt/Color;)V)
 */
public final class init_085 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KReference ref;
         ...
         // *********[256] GETFIELD(jnt.Bench.Applet,abortButton,Ljava/awt/Button;)
         ...
         // *********[258] INVOKEVIRTUAL(java.awt.Component,setBackground(Ljava/awt/Color;)V)
