 ...
 * [count=3] [151] ALOAD(8) [152] SIPUSH(Integer{250}) [153] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
 */
public final class send_081 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[152] SIPUSH(Integer{250})
         // **REMOVED Substitution** s1 = I250;
         // *********[153] INVOKESTATIC(jnt.Bench.SendMail,check(Ljava/io/DataInputStream;I)V)
