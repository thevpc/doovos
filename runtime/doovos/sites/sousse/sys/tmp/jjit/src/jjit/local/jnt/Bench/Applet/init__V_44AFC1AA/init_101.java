 ...
 * jnt.Bench.Applet
 * init()V
 * [count=4] [325] ALOAD(0) [326] ALOAD(0) [327] GETFIELD(jnt.Bench.Applet,status,Ljava/awt/Label;) [328] INVOKEVIRTUAL(java.awt.Container,add(Ljava/awt/Component;)Ljava/awt/Component;)
 */
public final class init_101 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KReference this_ref = ((KReference)frame.getLocal(0));
         ...
         // *********[327] GETFIELD(jnt.Bench.Applet,status,Ljava/awt/Label;)
         // **REMOVED Substitution** s1_ref = c_status.getInstanceRef(this_ref);
         // *********[328] INVOKEVIRTUAL(java.awt.Container,add(Ljava/awt/Component;)Ljava/awt/Component;)
