 ...
 * jnt.scimark2.Random
 * nextDoubles([D)V
 * [count=6] [57] ALOAD(0) [58] DUP [59] GETFIELD(jnt.scimark2.Random,j,I) [60] ICONST_1(Integer{1}) [61] ISUB [62] PUTFIELD(jnt.scimark2.Random,j)
 */
public final class nextDoubles_010 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        s0 = frame.getLocal(0);
         ...
         // *********[59] GETFIELD(jnt.scimark2.Random,j,I)
         ...
         // *********[62] PUTFIELD(jnt.scimark2.Random,j)
