 ...
 * jnt.scimark2.Random
 * nextDoubles([D)V
 * [count=6] [32] ALOAD(0) [33] DUP [34] GETFIELD(jnt.scimark2.Random,i,I) [35] ICONST_1(Integer{1}) [36] ISUB [37] PUTFIELD(jnt.scimark2.Random,i)
 */
public final class nextDoubles_005 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        s0 = frame.getLocal(0);
         ...
         // *********[34] GETFIELD(jnt.scimark2.Random,i,I)
         ...
         // *********[37] PUTFIELD(jnt.scimark2.Random,i)
