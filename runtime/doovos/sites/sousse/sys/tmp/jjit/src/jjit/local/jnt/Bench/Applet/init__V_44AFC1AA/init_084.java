 ...
 * jnt.Bench.Applet
 * init()V
 * [count=5] [250] PUTFIELD(jnt.Bench.Applet,abortButton) [251] ALOAD(0) [252] GETFIELD(jnt.Bench.Applet,abortButton,Ljava/awt/Button;) [253] ALOAD(2) [254] INVOKEVIRTUAL(java.awt.Component,setForeground(Ljava/awt/Color;)V)
 */
public final class init_084 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[250] PUTFIELD(jnt.Bench.Applet,abortButton)
        reg = frame.pop();
         // **REMOVED Substitution** ref = frame.popRef();
        c_abortButton.setInstanceValue(frame.popRef(),reg);
         // *********[251] ALOAD(0)
         // **REMOVED Substitution** s0 = frame.getLocal(0);
         // *********[252] GETFIELD(jnt.Bench.Applet,abortButton,Ljava/awt/Button;)
         ...
         // *********[254] INVOKEVIRTUAL(java.awt.Component,setForeground(Ljava/awt/Color;)V)
