 ...
 * [count=2] [9] ILOAD(4) [10] INVOKESTATIC(jnt.scimark2.MonteCarlo,integrate(I)D)
 */
public final class measureMonteCarlo_006 extends JJITAbstractInstruction implements Cloneable{
      ...
      public JJITInstruction run(KFrame frame) throws Exception {
        ...
        KLocalThread thread = frame.getThread();
         ...
         // *********[10] INVOKESTATIC(jnt.scimark2.MonteCarlo,integrate(I)D)
        ...
        if(m_mth == null){
          m_mth = c_CMonteCarlo.getMethodBySignature("integrate(I)D");
        }
