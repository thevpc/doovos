 ...
 * ====================================================================
 */
package jni.java.util.concurrent.atomic;
 ...
 */
@JNICLASS("java.util.concurrent.atomic.AtomicLong")
public class AtomicLongJNI {
    @JNICALL
    public static boolean VMSupportsCS8(JNIEnv env) throws RemoteException {
        return true;
    }
}