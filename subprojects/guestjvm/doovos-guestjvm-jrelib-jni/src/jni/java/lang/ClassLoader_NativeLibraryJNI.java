...
@JNICLASS("java.lang.ClassLoader$NativeLibrary")
public class ClassLoader_NativeLibraryJNI {

    @JNICALL
    public void load(JNIEnv env, @THIS KReference ref, @JNIPARAM("java.lang.String") KReference name) throws RemoteException {
        SimpleClassAdapter a = new SimpleClassAdapter(env, ref);
        a.setLong("handle", name.hashCode());
    }

    @JNICALL
    public long find(JNIEnv env, @THIS KReference ref, @JNIPARAM("java.lang.String") KReference name) {
        return name.hashCode();
    }

    @JNICALL
    public void unload(JNIEnv env, @THIS KReference ref) {
    }
