 ...
 */
@JNICLASS("java.lang.Float")
public class FloatJNI {
    @JNICALL
    public static int floatToIntBits(JNIEnv env, float f) {
        return Float.floatToIntBits(f);
    }

    @JNICALL
    public static int floatToRawIntBits(JNIEnv env, float value) {
        return Float.floatToRawIntBits(value);
    }

    @JNICALL
    public static float intBitsToFloat(JNIEnv env, int bits) {
