 ...
 */
@JNICLASS("sun.reflect.Reflection")
public class ReflectionJNI {
    @JNICALL(returnType = "java.lang.Class")
    public static KReference getCallerClass(JNIEnv env, int i) throws RemoteException {
        return env.getThread().getFrame(i).getKClass().getGuestReference();
    }

    @JNICALL
    public static int getClassAccessFlags(JNIEnv env, @JNIPARAM("java.lang.Class") KReference class1) throws RemoteException {
        return env.getClassRepository().getClassByGuestReference(class1).getDefinition().getModifiers();
    }
}
