 ...
 */
@JNICLASS(value="java.lang.Double",forceJNI=true)
public class DoubleJNIPerf {
    @JNICALL
    public static String toString(JNIEnv env,double d) {
	    return Double.toString(d);
    }

    @JNICALL
    public static String toHexString(JNIEnv env,double d) {
        return Double.toHexString(d);
    }

    @JNICALL
    public static int compare(JNIEnv env,double d1, double d2) {
