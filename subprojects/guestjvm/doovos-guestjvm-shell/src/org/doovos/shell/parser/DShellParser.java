...
import org.doovos.shell.parser.nodes.Node;

import java.io.InputStream;
import java.io.InputStreamReader;
import java.io.StringReader;

public class DShellParser {
    public DShellParser() {
    }

    public Node parse(String str) throws ParseException {
        DShellParserImpl parser = new DShellParserImpl(new StringReader(str));
        return parser.parse();
    }

    public Node parse(InputStream str) throws ParseException {
        DShellParserImpl parser = new DShellParserImpl(new InputStreamReader(str));
        return parser.parse();
    }
}