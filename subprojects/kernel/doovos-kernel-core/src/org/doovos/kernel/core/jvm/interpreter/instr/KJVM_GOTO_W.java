 ...
 */
public final class KJVM_GOTO_W extends KInstructionIdx implements Cloneable, KInstructionJump {
    public int label;


    public KJVM_GOTO_W(long[] operands) {
        super(KOperatorCodes.GOTO_W, operands);
    ...
    public boolean equals(Object o) {
        ...
        KJVM_GOTO_W kjvm_goto = (KJVM_GOTO_W) o;
