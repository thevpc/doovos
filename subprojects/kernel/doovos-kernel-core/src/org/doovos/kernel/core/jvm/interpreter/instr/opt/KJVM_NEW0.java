 ...
 */
public final class KJVM_NEW0 extends KInstructionIdx implements Cloneable {
    private int classNameIndex;
    protected KClass classByName;


    public KJVM_NEW0(int classNameIndex, KClass classByName) {
        super(KOperatorCodes.NEW, new long[]{classNameIndex});
    ...
    public boolean equals(Object o) {
        ...
        KJVM_NEW0 kjvm_new = (KJVM_NEW0) o;
