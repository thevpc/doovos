 ...
 */
public final class KJVM_LMUL extends KInstructionIdx implements Cloneable {
    public static final KJVM_LMUL INSTANCE = new KJVM_LMUL();


    private KJVM_LMUL() {
        super(KOperatorCodes.LMUL);
    }
