 ...
 * Time: 21:12:00
 */
public class KRuntimeFolderImpl extends KFixedPathRuntimeResourceImpl implements KLocalFolder, KFolder {

    public KRuntimeFolderImpl(String path) throws RemoteException {
        super(KResourceType.FOLDER, false, path);
    }
