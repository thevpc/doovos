 ...
 */
public final class KJVM_LXOR extends KInstructionIdx implements Cloneable {
    public static final KJVM_LXOR INSTANCE = new KJVM_LXOR();


    private KJVM_LXOR() {
        super(KOperatorCodes.LXOR);
    }
