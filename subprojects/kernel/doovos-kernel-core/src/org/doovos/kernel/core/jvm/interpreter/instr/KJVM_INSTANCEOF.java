...
import org.doovos.kernel.core.jvm.interpreter.instr.opt.KJVM_INSTANCEOF0;
 ...
 */
public final class KJVM_INSTANCEOF extends KInstructionIdx implements Cloneable {
    ...
    public KJVM_INSTANCEOF(long[] operands) {
        super(KOperatorCodes.INSTANCEOF, operands);
