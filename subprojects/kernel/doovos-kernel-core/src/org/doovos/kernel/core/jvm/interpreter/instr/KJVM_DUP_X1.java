 ...
 */
public final class KJVM_DUP_X1 extends KInstructionIdx implements Cloneable {
    public static final KJVM_DUP_X1 INSTANCE = new KJVM_DUP_X1();


    private KJVM_DUP_X1() {
        super(KOperatorCodes.DUP_X1);
    }
