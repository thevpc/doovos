...
public final class KJVM_DCMPL extends KInstructionIdx implements Cloneable {
    public static final KJVM_DCMPL INSTANCE = new KJVM_DCMPL();


    private KJVM_DCMPL() {
        super(KOperatorCodes.DCMPL);
    }
