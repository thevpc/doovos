 ...
 */
class NativeParamPrimitiveDoubleArray implements NativeParam {
    public static final NativeParam INSTANCE = new NativeParamPrimitiveDoubleArray();
    ...
    public Object toHost(KRegister reg, KFrame frame) throws RemoteException {
        ...
        return ref.isNull() ? null : MEMORY_MANAGER.getDoubleArray(((KReference) reg));
    }
