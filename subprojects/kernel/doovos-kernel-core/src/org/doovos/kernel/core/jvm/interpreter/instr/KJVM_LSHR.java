 ...
 */
public final class KJVM_LSHR extends KInstructionIdx implements Cloneable {
    public static final KJVM_LSHR INSTANCE = new KJVM_LSHR();


    private KJVM_LSHR() {
        super(KOperatorCodes.LSHR);
    }
