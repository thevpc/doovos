 ...
 */
class NativeParamPrimitiveShortArray implements NativeParam {
    public static final NativeParam INSTANCE = new NativeParamPrimitiveShortArray();
    ...
    public Object toHost(KRegister reg, KFrame frame) throws RemoteException {
        ...
        return ref.isNull() ? null : MEMORY_MANAGER.getShortArray(((KReference) reg));
    }
