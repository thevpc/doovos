 ...
 */
public final class KJVM_IRETURN extends KInstructionIdx implements Cloneable, KInstructionReturn {
    public static final KJVM_IRETURN INSTANCE = new KJVM_IRETURN();

    private KJVM_IRETURN() {
        super(KOperatorCodes.IRETURN);
    }
