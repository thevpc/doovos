...
public final class KJVM_DADD extends KInstructionIdx implements Cloneable {
    public static final KJVM_DADD INSTANCE = new KJVM_DADD();


    private KJVM_DADD() {
        super(KOperatorCodes.DADD);
    }
