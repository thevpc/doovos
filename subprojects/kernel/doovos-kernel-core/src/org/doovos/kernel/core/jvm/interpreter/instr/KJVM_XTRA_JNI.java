...
import org.doovos.kernel.core.jvm.interpreter.KInstructionIdxFactory;
 ...
 */
public final class KJVM_XTRA_JNI extends KInstructionIdx implements Cloneable {

    public static final KJVM_XTRA_JNI INSTANCE = new KJVM_XTRA_JNI();

    private KJVM_XTRA_JNI() {
        super(KInstructionIdxFactory.XTRA_JNI);
    }
