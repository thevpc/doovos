...
public final class KJVM_IDIV extends KInstructionIdx implements Cloneable {
    public static final KJVM_IDIV INSTANCE = new KJVM_IDIV();


    private KJVM_IDIV() {
        super(KOperatorCodes.IDIV);
    }
