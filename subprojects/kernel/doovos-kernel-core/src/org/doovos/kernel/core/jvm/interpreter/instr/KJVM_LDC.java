 ...
 */
public final class KJVM_LDC extends KInstructionIdx implements Cloneable {
    private int index;


    public KJVM_LDC(long[] operands) {
        super(KOperatorCodes.LDC, operands);
