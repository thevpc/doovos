...
*/
class NativeParamString implements NativeParam {
    public static final NativeParam INSTANCE = new NativeParamString();
    ...
    public Object toHost(KRegister reg, KFrame frame) throws RemoteException {
        ...
        return ref.isNull()?null: MEMORY_MANAGER.getString(ref);
    }
