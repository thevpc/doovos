 ...
 */
public final class KJVM_LUSHR extends KInstructionIdx implements Cloneable {
    public static final KJVM_LUSHR INSTANCE = new KJVM_LUSHR();


    private KJVM_LUSHR() {
        super(KOperatorCodes.LUSHR);
    }
