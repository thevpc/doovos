...
*/
class NativeParamPrimitiveDouble implements NativeParam {
    public static final NativeParam INSTANCE = new NativeParamPrimitiveDouble();
    public Object toHost(KRegister reg, KFrame frame) throws RemoteException {
        return ((KDouble) reg).value;
    }
