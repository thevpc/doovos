 ...
 */
public final class KJVM_POP2 extends KInstructionIdx implements Cloneable {
    public static final KJVM_POP2 INSTANCE = new KJVM_POP2();


    private KJVM_POP2() {
        super(KOperatorCodes.POP2);
    }
