...
public final class KJVM_DDIV extends KInstructionIdx implements Cloneable {
    public static final KJVM_DDIV INSTANCE = new KJVM_DDIV();


    private KJVM_DDIV() {
        super(KOperatorCodes.DDIV);
    }
