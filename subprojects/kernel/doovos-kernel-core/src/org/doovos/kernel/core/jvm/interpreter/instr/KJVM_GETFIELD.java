...
import org.doovos.kernel.core.jvm.interpreter.instr.opt.KJVM_GETFIELD0;
...
public final class KJVM_GETFIELD extends KInstructionIdx implements Cloneable {
    ...
    public KJVM_GETFIELD(long[] operands) {
        super(KOperatorCodes.GETFIELD, operands);
    ...
    public int run(KFrame frame) throws RemoteException {
        ...
        KRegister value = fieldByName.getInstanceValue(frame.popRef());
        frame.push(value);
