 ...
 */
public final class KJVM_DUP2_X1 extends KInstructionIdx implements Cloneable {
    public static final KJVM_DUP2_X1 INSTANCE = new KJVM_DUP2_X1();


    private KJVM_DUP2_X1() {
        super(KOperatorCodes.DUP2_X1);
    }
