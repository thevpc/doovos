 ...
 */
public final class KJVM_GOTO extends KInstructionIdx implements Cloneable, KInstructionJump {
    public int label;


    public KJVM_GOTO(long[] operands) {
        super(KOperatorCodes.GOTO, operands);
    ...
    public boolean equals(Object o) {
        ...
        KJVM_GOTO kjvm_goto = (KJVM_GOTO) o;
