 ...
 * @author vpc
 */
public class IntValueHashMap<V> implements Serializable {
...
//         * @param hash The code used to hash the object with
         ...
         */
        protected Entry(int hash,V key, int value, Entry next) {
            this.hash = hash;
            this.key = key;
            this.value = value;
            this.next = next;
...
//                /*e.value = */e.value++;
    ...
    public Collection<Integer> values() {
        ArrayList<Integer> map = new ArrayList<Integer>(size());
        Entry tab[] = table;
        for (int i = tab.length; i-- > 0;) {
...
//    }
    ...
    public Set<V> keySet() {
        HashSet<V> map = new HashSet<V>(size());
        Entry tab[] = table;
        for (int i = tab.length; i-- > 0;) {
            for (Entry<V> e = tab[i]; e != null; e = e.next) {
                map.add(e.key);
