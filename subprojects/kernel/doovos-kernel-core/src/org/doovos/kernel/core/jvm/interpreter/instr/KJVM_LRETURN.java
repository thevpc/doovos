 ...
 */
public final class KJVM_LRETURN extends KInstructionIdx implements Cloneable, KInstructionReturn {
    public static final KJVM_LRETURN INSTANCE = new KJVM_LRETURN();

    private KJVM_LRETURN() {
        super(KOperatorCodes.LRETURN);
    }
