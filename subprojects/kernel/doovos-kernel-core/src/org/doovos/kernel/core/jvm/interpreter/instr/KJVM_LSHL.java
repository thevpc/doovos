 ...
 */
public final class KJVM_LSHL extends KInstructionIdx implements Cloneable {
    public static final KJVM_LSHL INSTANCE = new KJVM_LSHL();


    private KJVM_LSHL() {
        super(KOperatorCodes.LSHL);
    }
