...
public final class KJVM_IAND extends KInstructionIdx implements Cloneable {
    public static final KJVM_IAND INSTANCE = new KJVM_IAND();


    private KJVM_IAND() {
        super(KOperatorCodes.IAND);
    }
