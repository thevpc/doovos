...
public final class KJVM_DCMPG extends KInstructionIdx implements Cloneable {
    public static final KJVM_DCMPG INSTANCE = new KJVM_DCMPG();


    private KJVM_DCMPG() {
        super(KOperatorCodes.DCMPG);
    }
