 ...
 */
public final class KJVM_LREM extends KInstructionIdx implements Cloneable {
    public static final KJVM_LREM INSTANCE = new KJVM_LREM();


    private KJVM_LREM() {
        super(KOperatorCodes.LREM);
    }
