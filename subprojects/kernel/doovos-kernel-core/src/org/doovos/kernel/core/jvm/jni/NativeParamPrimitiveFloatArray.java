 ...
 */
class NativeParamPrimitiveFloatArray implements NativeParam {
    public static final NativeParam INSTANCE = new NativeParamPrimitiveFloatArray();
    ...
    public Object toHost(KRegister reg, KFrame frame) throws RemoteException {
        ...
        return ref.isNull() ? null : MEMORY_MANAGER.getFloatArray(((KReference) reg));
    }
