...
import org.doovos.kernel.core.jvm.interpreter.instr.opt.KJVM_PUTFIELD0;
 ...
 */
public final class KJVM_PUTFIELD extends KInstructionIdx implements Cloneable {
    ...
    public KJVM_PUTFIELD(long[] operands) {
        super(KOperatorCodes.PUTFIELD, operands);
