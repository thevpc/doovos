...
import org.doovos.kernel.core.jvm.interpreter.instr.opt.KJVM_GETSTATIC0;
 ...
 */
public final class KJVM_GETSTATIC extends KInstructionIdx implements Cloneable {
    ...
    public KJVM_GETSTATIC(long[] operands) {
        super(KOperatorCodes.GETSTATIC, operands);
