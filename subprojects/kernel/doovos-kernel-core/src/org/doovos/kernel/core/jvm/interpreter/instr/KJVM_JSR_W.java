 ...
 */
public final class KJVM_JSR_W extends KInstructionIdx implements Cloneable, KInstructionJump {
    public int label;
    public int ordinal;


    public KJVM_JSR_W(int ordinal,long[] operands) {
        super(KOperatorCodes.JSR, operands);
    ...
    public boolean equals(Object o) {
        ...
        KJVM_JSR_W kjvm_goto = (KJVM_JSR_W) o;
