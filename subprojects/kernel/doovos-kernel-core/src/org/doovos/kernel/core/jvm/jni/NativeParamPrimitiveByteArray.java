 ...
 */
class NativeParamPrimitiveByteArray implements NativeParam {
    public static final NativeParam INSTANCE = new NativeParamPrimitiveByteArray();
    ...
    public Object toHost(KRegister reg, KFrame frame) throws RemoteException {
        ...
        return ref.isNull() ? null : MEMORY_MANAGER.getByteArray(((KReference) reg));
    }
