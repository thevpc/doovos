 ...
 */
public final class KJVM_FRETURN extends KInstructionIdx implements Cloneable, KInstructionReturn {
    public static final KJVM_FRETURN INSTANCE = new KJVM_FRETURN();

    private KJVM_FRETURN() {
        super(KOperatorCodes.FRETURN);
    }
