...
public final class KJVM_DSUB extends KInstructionIdx implements Cloneable {
    public static final KJVM_DSUB INSTANCE = new KJVM_DSUB();


    private KJVM_DSUB() {
        super(KOperatorCodes.DSUB);
    }
