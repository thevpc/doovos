 ...
 * Created by IntelliJ IDEA.
  ...
  */
 public class KFieldShort extends KField {
    private final int byteOffset = definition.getByteOffset();
    public KFieldShort(KFieldDef definition, KClass field) throws RemoteException {
        super(definition, field);
    }

    @Override
    public void setInstanceValue(KReference ref, KRegister value) throws RemoteException {
        memoryManager.setFieldShort(ref, byteOffset, value.shortValue());
    }

    @Override
    public KRegister getInstanceValue(KReference ref) throws RemoteException {
        return new KShort(memoryManager.getFieldShort(ref, byteOffset));
    }

    @Override
    public void setStaticValue(KRegister value) throws RemoteException {
        staticSegment.setFieldShort(staticPointer, byteOffset, value.shortValue());
    }

    @Override
    public KRegister getStaticValue() throws RemoteException {
        return new KShort(staticSegment.getFieldShort(staticPointer, byteOffset));
    }
...
//        return new KShort(DMemoryUtils.byteArray2short(content, byteOffset));
//    }
