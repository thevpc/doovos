 ...
 * ====================================================================
 */
package org.doovos.kernel.api.io.term;
...
public interface KTerminal extends KResource {
    ...
    KInputStream getIn() throws RemoteException;

    KOutputStream getOut() throws RemoteException;

    KOutputStream getErr() throws RemoteException;
}
