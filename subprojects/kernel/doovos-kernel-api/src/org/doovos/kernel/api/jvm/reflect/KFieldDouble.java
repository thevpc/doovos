 ...
 */
public class KFieldDouble extends KField {

    private final int byteOffset = definition.getByteOffset();

    public KFieldDouble(KFieldDef definition, KClass field) throws RemoteException {
        super(definition, field);
    }

    @Override
    public void setStaticValue(KRegister value) throws RemoteException {
        staticSegment.setFieldDouble(staticPointer, byteOffset, value.doubleValue());
    }

    @Override
    public KRegister getStaticValue() throws RemoteException {
        return new KDouble(staticSegment.getFieldDouble(staticPointer, byteOffset));
    }

    @Override
    public void setInstanceValue(KReference ref, KRegister value) throws RemoteException {
        memoryManager.setFieldDouble(ref, byteOffset, value.doubleValue());
    }

    @Override
    public KRegister getInstanceValue(KReference ref) throws RemoteException {
        return new KDouble(memoryManager.getFieldDouble(ref, byteOffset));
    }

    public double getInstanceDouble(KReference ref) throws RemoteException {
        return memoryManager.getFieldDouble(ref, byteOffset);
    }
...
//        DMemoryUtils.double2byteArray(((KDouble) value).value, content, byteOffset);
//    }
    /**
...
//        return new KDouble(DMemoryUtils.byteArray2double(content, byteOffset));
//    }
}