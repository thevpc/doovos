...
import org.doovos.kernel.api.filesystem.KLocalResourceDelegate;

import java.io.IOException;
import java.io.OutputStream;
import java.rmi.RemoteException;

public class KLocalOutputStreamDelegate extends KLocalResourceDelegate implements KLocalOutputStream {
    public KLocalOutputStreamDelegate(KLocalOutputStream delegate) {
        super(delegate);
    }

    private KLocalOutputStream getBase() throws RemoteException {
        return (KLocalOutputStream) getDelegate();
    }
    ...
    public void writeln(String message, Attributes attributes) throws RemoteException {
        getBase().writeln(message, attributes);
    }
    ...
    public void write(Object message, Attributes attributes) throws RemoteException {
        getBase().write(message, attributes);
    }
