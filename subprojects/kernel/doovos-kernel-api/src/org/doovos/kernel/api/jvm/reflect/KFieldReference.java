 ...
 * Created by IntelliJ IDEA.
  ...
  */
 public class KFieldReference extends KField {
    private final int byteOffset = definition.getByteOffset();
    public KFieldReference(KFieldDef definition, KClass field) throws RemoteException {
        super(definition, field);
    }

    @Override
    public void setInstanceValue(KReference ref, KRegister value) throws RemoteException {
        memoryManager.setFieldReference(ref, byteOffset, (KReference)value);
    }

    @Override
    public KRegister getInstanceValue(KReference ref) throws RemoteException {
        return memoryManager.getFieldReference(ref, byteOffset);
    }
    ...
    public void setStaticValue(KRegister value) throws RemoteException {
        staticSegment.setFieldReference(staticPointer, byteOffset, (KReference) value);
    }

    @Override
    public KRegister getStaticValue() throws RemoteException {
        return staticSegment.getFieldReference(staticPointer, byteOffset);
    }
}