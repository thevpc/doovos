 ...
 * Time: 13:01:04
 */
public interface KClassRepository extends KResource {

    public KClass getArrayClass(KClass clazz, int depth) throws RemoteException;

//    public KClass getClassByName(String name, long version) throws RemoteException;

    public KClass getClassByName(String name) throws RemoteException;


//    public KClassDef getClassDef(String name, long version) throws RemoteException;

    public void init(KClassLoader classLoader, KMemorySegment memorySegment, Properties newEnvArray) throws RemoteException;
