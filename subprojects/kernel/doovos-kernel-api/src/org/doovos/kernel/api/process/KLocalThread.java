...
/**
 * Interface for Local Processes handling
 *
 * @author vpc (taha.bensalah@gmail.com)
 * @lastmodified 21 déc. 2005
 * Time: 01:58:04
 */
public interface KLocalThread extends KThread, KLocalResource/*, Runnable*/ {
    ...
    /**
     * execute the current statement and increment the ordinal counter
     */
    ...
    public abstract KFrame pushFrame( KMethod method, KRegister... parameters) throws RemoteException;

    public boolean pushClassInitializerFrame(KClass dpc) throws RemoteException;

    public void initialize(KProcess process, KInterpreter interpreter,String clazz, String method, KRegister[] parameters) throws RemoteException;

    /**
     * @return the invoker context (after popping actua context)
    ...
    KProcessCache getCache() throws RemoteException;
}