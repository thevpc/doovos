 ...
 * Created by IntelliJ IDEA.
  ...
  */
 public class KFieldByte extends KField {
    private final int byteOffset = definition.getByteOffset();
    public KFieldByte(KFieldDef definition, KClass field) throws RemoteException {
        super(definition, field);
    }

    @Override
    public void setStaticValue(KRegister value) throws RemoteException {
        staticSegment.setFieldByte(staticPointer, byteOffset, value.byteValue());
    }

    @Override
    public KRegister getStaticValue() throws RemoteException {
        return KByte.valueOf(staticSegment.getFieldByte(staticPointer, byteOffset));
    }

    @Override
    public void setInstanceValue(KReference ref, KRegister value) throws RemoteException {
        memoryManager.setFieldByte(ref, byteOffset, value.byteValue());
    }

    @Override
    public KRegister getInstanceValue(KReference ref) throws RemoteException {
        return KByte.valueOf(memoryManager.getFieldByte(ref, byteOffset));
    }
}