...
// */
//public final class KJVM_BALOAD extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_BALOAD INSTANCE = new KJVM_BALOAD();
//    protected KInstruction next;
//
//    private KJVM_BALOAD() {
//        super(KOperator.BALOAD);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        int index = frame.popInt();
//        KReference ref = frame.popReference();
//        frame.push(new KInteger(Doovos.getSystem().getMemoryManager().getByteArray(ref, index)));
...
//                },
//                "    {\n"
//                        + "        int index = context.popInt();\n" +
//                        "        KReference ref = " + jitContext.popReference() + ";\n" +
//                        "        int value = memoryManager.getByteArray(ref, index);\n" +
//                        "        KInteger registerInteger = new KInteger(value);\n" +
//                        "        " + jitContext.pushConsumed("registerInteger")
//                        + "\n    }"
//                , null, null, null
//        );
//    }
