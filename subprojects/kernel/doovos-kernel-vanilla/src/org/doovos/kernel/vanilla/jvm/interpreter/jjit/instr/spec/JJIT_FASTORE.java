...
public final class JJIT_FASTORE extends JJIT__BASE_XASTORE {
    public static final JJIT_FASTORE INSTANCE = new JJIT_FASTORE();

    private JJIT_FASTORE() {
        super(KOperator.FASTORE, KRegisterType.FLOAT, null, Calls.MemoryManager_setFloatArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            memoryManager.setFloatArray(frame.popRef(), index, val);
            return next;
        }
