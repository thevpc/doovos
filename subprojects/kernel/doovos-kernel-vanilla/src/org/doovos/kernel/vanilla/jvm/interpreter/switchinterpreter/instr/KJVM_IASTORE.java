...
// */
//public final class KJVM_IASTORE extends KInstructionSwitch implements Cloneable, KInstructionStore {
//    public static final KJVM_IASTORE INSTANCE = new KJVM_IASTORE();
//    protected KInstruction next;
//
//    private KJVM_IASTORE() {
//        super(KOperator.IASTORE);
//    }
//
...
//        Doovos.getSystem().getMemoryManager().setIntArray(ref, index, value);
...
//                        "        memoryManager.setIntArray(ref, index, value);\n"
//                        + "\n    }"
//                , null, null, null
//        );
//    }
