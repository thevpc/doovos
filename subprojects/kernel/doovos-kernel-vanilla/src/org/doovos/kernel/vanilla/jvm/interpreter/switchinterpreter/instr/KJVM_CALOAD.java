...
//
//public final class KJVM_CALOAD extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_CALOAD INSTANCE = new KJVM_CALOAD();
//    protected KInstruction next;
//
//    private KJVM_CALOAD() {
//        super(KOperator.CALOAD);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        int index = frame.popInt();
//        KReference ref = frame.popReference();
//        frame.push(new KInteger(Doovos.getSystem().getMemoryManager().getCharArray(ref, index)));
...
//                        "        char value = memoryManager.getCharArray(ref, index);\n" +
