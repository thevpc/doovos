...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_FCALC;
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.src.JJITMathOp;

public final class JJIT_FREM extends JJIT__BASE_FCALC {
    public static final JJIT_FREM INSTANCE = new JJIT_FREM();

    private JJIT_FREM() {
        super(KOperator.FREM,JJITMathOp.REM);
    }
    ...
    public JJITInstruction createSingleInstruction(Object[] constantDefs, IntHashMap labels) {
        return new JJITInstructionSingle() {
            ...
            public JJITInstruction run(KFrame frame) throws Exception {
                ...
                frame.push(new KFloat(frame.popFloat() % b));
                return next;
            }
        };
    }
