...
public abstract class JJIT__BASE_DCALC extends JJITInstructionDef {

    private JJITMathOp calcOp;

    protected JJIT__BASE_DCALC(KOperator op, JJITMathOp calcOp) {
        super(op);
        this.calcOp = calcOp;
    }
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        final JJITName v2 = r.declareLocalVar(Types.DOUBLE, "d", null);
        r.popDouble(v2);
        r.pushDoubles(r.popDouble().calc(calcOp, v2));
    }

    @Override
    public JJITChanges getChanges(JJITChangeModel model) {
        //new KRegisterType[]{KRegisterType.DOUBLE, KRegisterType.DOUBLE}, new KRegisterType[]{KRegisterType.INTEGER}
    ...
    public boolean equals(Object obj) {
        ...
        final JJIT__BASE_DCALC other = (JJIT__BASE_DCALC) obj;
    ...
    public int hashCode() {
        int hash = 5;
        hash = 19 * hash + (this.calcOp != null ? this.calcOp.hashCode() : 0);
        return hash;
    }
