...
// */
//public final class KJVM_LLOAD extends KInstructionSwitch implements Cloneable, KInstructionLoad {
//    private int index;
//    protected KInstruction next;
//    public static final KJVM_LLOAD LLOAD_0 = new KJVM_LLOAD(KOperator.LLOAD_0, 0);
//    public static final KJVM_LLOAD LLOAD_1 = new KJVM_LLOAD(KOperator.LLOAD_1, 1);
//    public static final KJVM_LLOAD LLOAD_2 = new KJVM_LLOAD(KOperator.LLOAD_2, 2);
//    public static final KJVM_LLOAD LLOAD_3 = new KJVM_LLOAD(KOperator.LLOAD_3, 3);
//
//    private KJVM_LLOAD(KOperator op, int value) {
//        super(op);
//        this.index = value;
//    }
//
//    public KJVM_LLOAD(long[] operands) {
//        super(KOperator.LLOAD, operands);
