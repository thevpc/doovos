 ...
 * ====================================================================
 */
public final class JJIT_DALOAD extends JJIT__BASE_XALOAD {

    public static final JJIT_DALOAD INSTANCE = new JJIT_DALOAD();

    private JJIT_DALOAD() {
        super(KOperator.DALOAD, Types.KDOUBLE, Calls.MemoryManager_getDoubleArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            frame.push(new KDouble(memoryManager.getDoubleArray(frame.popRef(), index)));
            return next;
        }
