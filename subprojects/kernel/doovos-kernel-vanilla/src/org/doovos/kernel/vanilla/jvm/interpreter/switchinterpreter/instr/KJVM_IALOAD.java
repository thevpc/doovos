...
//
//public final class KJVM_IALOAD extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_IALOAD INSTANCE = new KJVM_IALOAD();
//    protected KInstruction next;
//
//    private KJVM_IALOAD() {
//        super(KOperator.IALOAD);
//    }
//
...
//                        "        int value = Doovos.getSystem().getMemoryManager().getIntArray(ref, index);\n" +
//                        "        KInteger registerDouble = new KInteger(value);\n" +
//                        "        context.push(registerDouble);"
//                        + "\n    }"
//                , null, null, null
//        );
//    }
