 ...
 */
public final class JJIT_DUP2_X1Type2 extends JJITInstructionDef {

    public static final JJIT_DUP2_X1Type2 INSTANCE = new JJIT_DUP2_X1Type2();

    private JJIT_DUP2_X1Type2() {
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        ...
        if (t1.isType2()) {
            ...
            return new JJITChanges(
                    JJITChangeOp.Pop(t1), JJITChangeOp.Pop(t2), JJITChangeOp.Pop(t3), JJITChangeOp.Pop(t4),
