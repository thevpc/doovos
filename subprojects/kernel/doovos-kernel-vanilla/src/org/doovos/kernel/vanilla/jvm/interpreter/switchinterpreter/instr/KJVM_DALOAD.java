...
//
//public final class KJVM_DALOAD extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_DALOAD INSTANCE = new KJVM_DALOAD();
//    protected KInstruction next;
//
//    private KJVM_DALOAD() {
//        super(KOperator.DALOAD);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        int index = frame.popInt();
//        KReference ref = frame.popReference();
//        frame.push(new KDouble(Doovos.getSystem().getMemoryManager().getDoubleArray(ref, index)));
...
//                        "       " + jitContext.pushConsumed("new KDouble(memoryManager.getDoubleArray(ref, index))")
//                        + "    }"
//                , null, null, null
//        );
//    }
