...
// */
//public final class KJVM_ARRAYLENGTH extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_ARRAYLENGTH INSTANCE = new KJVM_ARRAYLENGTH();
//    protected KInstruction next;
//
//    private KJVM_ARRAYLENGTH() {
//        super(KOperator.ARRAYLENGTH);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        frame.push(new KInteger(Doovos.getSystem().getMemoryManager().getArraySize(frame.popReference())));
//        //**LOG**//log(i.operator, context, "@" + ref + " => " + value);
...
//                },
//                "    " + jitContext.pushConsumed("(new KInteger(memoryManager.getArraySize(" + jitContext.popReference() + ")))")
//                , null, null, null
//        );
//    }
//}