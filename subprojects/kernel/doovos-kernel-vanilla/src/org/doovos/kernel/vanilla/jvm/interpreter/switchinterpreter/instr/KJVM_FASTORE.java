...
//
//public final class KJVM_FASTORE extends KInstructionSwitch implements Cloneable, KInstructionStore {
//    public static final KJVM_FASTORE INSTANCE = new KJVM_FASTORE();
//    protected KInstruction next;
//
//    private KJVM_FASTORE() {
//        super(KOperator.FASTORE);
//    }
//
...
//                },
//                "    {\n"
//                        + "        float value = " + jitContext.popFloat() + ";\n" +
//                        "        int index = " + jitContext.popInt() + ";\n" +
//                        "        KReference ref = " + jitContext.popReference() + ";\n" +
//                        "        memoryManager.setFloatArray(ref, index, value);\n"
//                        + "    }"
//                , null, null, null
//        );
//    }
