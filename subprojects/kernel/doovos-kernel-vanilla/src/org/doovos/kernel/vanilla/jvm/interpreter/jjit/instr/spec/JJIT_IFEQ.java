...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_IF_0;
...
public final class JJIT_IFEQ extends JJIT__BASE_IF_0 {

    public JJIT_IFEQ(int label) {
        super(KOperator.IFEQ, JJITCmpOp.EQ, label);
    }
    ...
    private static class Single extends JJITInstructionSingle implements Cloneable {
        ...
        private Single(JJIT__BASE_IF_0 d, int label, IntHashMap labels) {
            super(d);
