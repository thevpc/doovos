...
//
//public final class KJVM_FCONST extends KInstructionSwitch implements Cloneable {
//    //    public static final KJVM_FCONST FCONST_M1=new KJVM_FCONST(KJVMOperator.FCONST_M1,KInteger.M1);
//    public static final KJVM_FCONST FCONST_0 = new KJVM_FCONST(KOperator.FCONST_0, KFloat.ZERO);
//    public static final KJVM_FCONST FCONST_1 = new KJVM_FCONST(KOperator.FCONST_1, KFloat.ONE);
//    public static final KJVM_FCONST FCONST_2 = new KJVM_FCONST(KOperator.FCONST_2, KFloat.TWO);
...
//
//    private KJVM_FCONST(KOperator operator, KFloat value) {
//        super(operator);
//        this.value = value;
//    }
//
...
//        String v = "KFloat_" + String.valueOf(value.value).replace('-', 'M');
...
//                null,
//                new String[]{
//                        "KFloat " + v + "= new KFloat(" + value.value + ")"
//                }, null,
//                code
//                , null, null, null
//        );
