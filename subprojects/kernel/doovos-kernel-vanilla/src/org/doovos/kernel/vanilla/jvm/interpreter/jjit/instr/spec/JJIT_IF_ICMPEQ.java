...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_IF;
 ...
 */
public final class JJIT_IF_ICMPEQ extends JJIT__BASE_IF{

    public JJIT_IF_ICMPEQ(int label) {
        super(KOperator.IF_ICMPEQ,JJITCmpOp.EQ,label);
    }
    ...
    private static class Single extends JJITInstructionSingle implements Cloneable {
        ...
        private Single(JJIT__BASE_IF d, int label, IntHashMap labels) {
            super(d);
