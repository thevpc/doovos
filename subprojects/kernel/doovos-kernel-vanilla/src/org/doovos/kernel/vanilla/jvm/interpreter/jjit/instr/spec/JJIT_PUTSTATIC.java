 ...
 */
public final class JJIT_PUTSTATIC extends JJITInstructionDef {
    ...
    public JJIT_PUTSTATIC(Object[] constants,int cls, int fld,int typeIndex) {
        super(KOperator.PUTSTATIC);
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        r.addCode(v.call(Calls.KField_setStaticValue, r.pop()));
    }

    @Override
    public JJITChanges getChanges(JJITChangeModel model) {
        return new JJITChanges(JJITChangeOp.Pop(JavaByteCodeUtils.getRegisterTypeByClassCode(typeName)));
    }
 ...
 @Override
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable{
        ...
        private Single(JJIT_PUTSTATIC d) {
            super(d);
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            kfield.setStaticValue(frame.pop());
            return next;
        }
    ...
    public boolean equals(Object obj) {
        ...
        final JJIT_PUTSTATIC other = (JJIT_PUTSTATIC) obj;
