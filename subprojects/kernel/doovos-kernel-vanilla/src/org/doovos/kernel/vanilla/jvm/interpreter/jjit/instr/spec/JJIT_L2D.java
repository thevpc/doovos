...
import static org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.JJITChangeOp.PUSH_DOUBLE;
 ...
 */
public final class JJIT_L2D extends JJIT__BASE_X2X {

    public static final JJIT_L2D INSTANCE = new JJIT_L2D();
    ...
    public JJITInstruction createSingleInstruction(Object[] constantDefs, IntHashMap labels) {
        return new JJITInstructionSingle() {
            ...
            public JJITInstruction run(KFrame frame) throws Exception {
                frame.push(new KDouble((double) frame.popLong()));
                return next;
            }
        };
    }
