 ...
 */
public final class JJIT_GETFIELD extends JJITInstructionDef {
    ...
    public JJIT_GETFIELD(Object[] constants, int cls, int fld, int typeIndex) {
        super(KOperator.GETFIELD);
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        return new JJITChanges(JJITChangeOp.POP_REF, JJITChangeOp.Push(JavaByteCodeUtils.getRegisterTypeByClassCode(typeName)));
    }

    @Override
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        final JJITMethodSourceRun r = cls.run();
        r.push(r.getInstanceValue(className, fieldName, typeName));
//        if (cls.getBaseMethodClassName().equals(className)) {
//            final JJITMethodSourceInit i = cls.init();
//            final JJITName v = i.declareAndInitKField(className, fieldName);
//            r.push(v.call(KClassDef.isPrimitiveTypeCode(typeName)? "getInstanceValue":"getInstanceRef", r.popRef()));
//        } else {
//            final JJITName v = r.declareAndInitKField(className, fieldName);
//            r.push(v.call("getInstanceValue", r.popRef()));
//        }
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        private Single(JJIT_GETFIELD d) {
            super(d);
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            frame.push(kfield.getInstanceValue(frame.popRef()));
            return next;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        final JJIT_GETFIELD other = (JJIT_GETFIELD) obj;
