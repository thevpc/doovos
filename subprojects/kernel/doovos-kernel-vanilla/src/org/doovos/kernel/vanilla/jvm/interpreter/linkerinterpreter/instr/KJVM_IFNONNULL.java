...
// */
//public final class KJVM_IFNONNULL extends KJVM__IF {
//    public KJVM_IFNONNULL(long[] operands) {
//        super(KOperator.IFNONNULL, operands);
//    }
//
...
//        if (!value1.isNull()) {
//            //**LOG**//log(i.operator, context, value1 + "<>? NULL =>jump to " + (int) this.operands[0]);
//            return label;
//        }
//        //**LOG**//log(i.operator, context, value1 + "<>? NULL =>no jump");
...
//                null,
//                new String[]{"private KInstruction nextLabel"},
//                new String[]{
//                        "boolean jump"
//                },
//                "    jump=!((" + jitContext.popReference() + ").isNull()) ;\n"
