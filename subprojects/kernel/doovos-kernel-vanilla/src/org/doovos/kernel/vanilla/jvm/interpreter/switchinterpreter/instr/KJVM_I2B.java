...
// */
//public final class KJVM_I2B extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_I2B INSTANCE = new KJVM_I2B();
...
//        frame.push(new KInteger((byte) value));
...
//                null,
//                null, null,
//                "    " + jitContext.pushConsumed("new KInteger((byte)(" + jitContext.popInt() + "))")
//                , null, null, null
//        );
//    }
//
