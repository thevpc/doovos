...
// * ====================================================================
// */
//package org.doovos.kernel.vanilla.jvm.interpreter.linkerinterpreter.instr.opt;
//
...
//import org.doovos.kernel.vanilla.jvm.interpreter.linkerinterpreter.instr.KJVM__Constants;
//
///**
...
// */
//public final class KJVM_PUTSTATIC0 extends KInstructionLnk implements Cloneable {
...
//    
//
//    public KJVM_PUTSTATIC0(int classNameIndex,int attributeIndex,KClass classByName,KField fieldByName) {
//        super(KOperator.PUTSTATIC, new long[]{classNameIndex,attributeIndex});
...
//                        "      String className =\"" + classByName.getName() + "\";\n" +
//                        "      String attributeName =\"" + fieldByName.getName() + "\";\n" +
...
//                        "      if(!jump){\n" +
//                        "        classByName.setStaticFieldValue(attributeName, " + jitContext.pop() + ",currentProcess.getGarbageCollector());\n" +
//                        "      }\n" +
//                        "    }\n"
...
//
//        KJVM_PUTSTATIC0 that = (KJVM_PUTSTATIC0) o;
//
