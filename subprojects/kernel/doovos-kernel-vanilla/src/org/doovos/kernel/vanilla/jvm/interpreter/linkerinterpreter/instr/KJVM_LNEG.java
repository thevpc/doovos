...
// */
//public final class KJVM_LNEG extends KInstructionLnk implements Cloneable {
//    public static final KJVM_LNEG INSTANCE = new KJVM_LNEG();
//    
//
//    private KJVM_LNEG() {
...
//                null, null,
//                "    {\n" +
//                        "       " + jitContext.pushConsumed("new KLong(-(" + jitContext.popLong() + "))") + "\n"
//                        + "    }"
//                , null, null, null
//        );
//    }
