...
public class KJVM_LRETURNDump implements Opcodes {
    ...
    public byte[] dump() throws Exception {
        ...
        cw.visit(V1_6, ACC_PUBLIC + ACC_FINAL, "KJVM_LRETURN", null, "org/doovos/kernel/vanilla/jvm/interpreter/linkerinterpreter/KInstructionLnk", new String[]{"java/lang/Cloneable", "org/doovos/kernel/core/jvm/interpreter/instr/groups/KInstructionReturn"});

        {
            fv = cw.visitField(ACC_PUBLIC + ACC_FINAL + ACC_STATIC, "INSTANCE", "LKJVM_LRETURN;", null, null);
            fv.visitEnd();
        }
        {
        ...
        }
        {
            ...
            mv.visitFieldInsn(PUTFIELD, "KJVM_LRETURN", "ordinal", "I");
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 4);
            mv.visitEnd();
        }
        ...
        }
        {
            ...
            mv.visitCode();
            mv.visitTypeInsn(NEW, "KJVM_LRETURN");
            mv.visitInsn(DUP);
            mv.visitMethodInsn(INVOKESPECIAL, "KJVM_LRETURN", "<init>", "()V");
            mv.visitFieldInsn(PUTSTATIC, "KJVM_LRETURN", "INSTANCE", "LKJVM_LRETURN;");
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 0);
            mv.visitEnd();
        }
