...
// */
//public final class KJVM_LASTORE_1 extends KInstructionLnk implements Cloneable, KInstructionStore {
//    public static final KJVM_LASTORE INSTANCE = new KJVM_LASTORE();
//    
//
//    private KJVM_LASTORE_1() {
//        super(KOperator.LASTORE);
//    }
//
...
//        Doovos.getSystem().getMemoryManager().setLongArray(ref, index, value);
...
//                },
//                "    {\n"
//                        + "       long value = " + jitContext.popLong() + ";\n" +
//                        "       int index = " + jitContext.popInt() + ";\n" +
//                        "       KReference ref = " + jitContext.popReference() + ";\n" +
//                        "       memoryManager.setLongArray(ref, index, value);\n"
//                        + "    }"
//                , null, null, null
//        );
//    }
