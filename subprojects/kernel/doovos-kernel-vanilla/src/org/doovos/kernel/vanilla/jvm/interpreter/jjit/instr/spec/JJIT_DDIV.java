...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_DCALC;
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.src.JJITMathOp;

public final class JJIT_DDIV extends JJIT__BASE_DCALC {
    public static final JJIT_DDIV INSTANCE = new JJIT_DDIV();

    private JJIT_DDIV() {
        super(KOperator.DDIV,JJITMathOp.DIV);
    }
    ...
    public JJITInstruction createSingleInstruction(Object[] constantDefs, IntHashMap labels) {
        return new JJITInstructionSingle() {
            ...
            public JJITInstruction run(KFrame frame) throws Exception {
                ...
                frame.push(new KDouble(frame.popDouble() / b));
                return next;
            }
        };
    }
