...
public final class JJIT_DUP2Type2 extends JJITInstructionDef {

    public static final JJIT_DUP2Type2 INSTANCE = new JJIT_DUP2Type2();

    private JJIT_DUP2Type2() {
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        ...
        return new JJITChanges(JJITChangeOp.Pop(t1), JJITChangeOp.Push(t1), JJITChangeOp.Push(t1));
    }
