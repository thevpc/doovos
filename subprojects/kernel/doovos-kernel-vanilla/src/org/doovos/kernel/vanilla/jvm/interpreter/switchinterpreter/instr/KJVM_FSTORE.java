...
// */
//public final class KJVM_FSTORE extends KInstructionSwitch implements Cloneable, KInstructionStore {
//    public static final KJVM_FSTORE FSTORE_0 = new KJVM_FSTORE(KOperator.FSTORE_0, 0);
//    public static final KJVM_FSTORE FSTORE_1 = new KJVM_FSTORE(KOperator.FSTORE_1, 1);
//    public static final KJVM_FSTORE FSTORE_2 = new KJVM_FSTORE(KOperator.FSTORE_2, 2);
//    public static final KJVM_FSTORE FSTORE_3 = new KJVM_FSTORE(KOperator.FSTORE_3, 3);
//
//    private int index;
//    protected KInstruction next;
//
//    private KJVM_FSTORE(KOperator op, int index) {
//        super(op);
//        this.index = index;
//    }
//
//    public KJVM_FSTORE(long[] operands) {
//        super(KOperator.DSTORE, operands);
...
//                null,
//                null, null,
//                "    context.setLocal(" + index + ", context.pop());"
//                , null, null, null
//        );
//    }
//
...
//
//        KJVM_FSTORE that = (KJVM_FSTORE) o;
//
