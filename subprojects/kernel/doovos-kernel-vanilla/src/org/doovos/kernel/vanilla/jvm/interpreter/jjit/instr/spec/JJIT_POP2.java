...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.special.JJIT_POP2Type1;
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.special.JJIT_POP2Type2;
...
public final class JJIT_POP2 extends JJITInstructionDef {

    public static final JJIT_POP2 INSTANCE = new JJIT_POP2();
    ...
    public JJITInstructionDef transform(JJITTransformerContext context) {
        if (context.getNode().getChanges().get(0).getRegisterType().isType2()) {
            return JJIT_POP2Type2.INSTANCE;
        } else {
            return JJIT_POP2Type1.INSTANCE;
        }
    }
