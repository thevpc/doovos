...
//
//public final class KJVM_CASTORE extends KInstructionSwitch implements Cloneable, KInstructionStore {
//    public static final KJVM_CASTORE INSTANCE = new KJVM_CASTORE();
//    protected KInstruction next;
//
//    private KJVM_CASTORE() {
//        super(KOperator.CASTORE);
//    }
//
...
//        Doovos.getSystem().getMemoryManager().setCharArray(ref, index, (char) value);
...
//                        "        memoryManager.setCharArray(ref, index, (char) value);"
//                        + "    }"
//                , null, null, null
//        );
//    }
