...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_DCMP;
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.src.helpers.Fields;

public final class JJIT_DCMPG extends JJIT__BASE_DCMP {

    public static final JJIT_DCMPG INSTANCE = new JJIT_DCMPG();

    private JJIT_DCMPG() {
        super(KOperator.DCMPG, Fields.KInteger_ONE);
    }
