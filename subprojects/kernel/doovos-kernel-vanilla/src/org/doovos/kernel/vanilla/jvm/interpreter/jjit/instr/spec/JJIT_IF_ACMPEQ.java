...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_IF_A;
 ...
 */
public final class JJIT_IF_ACMPEQ extends JJIT__BASE_IF_A {

    public JJIT_IF_ACMPEQ(int label) {
        super(KOperator.IF_ACMPEQ, label);
    }

    @Override
    protected JJITExpression cmp(JJITName ref, JJITName ref2) {
        final JJITExpressionImpl eq1 = ref.field(Fields.KReference_POINTER).eq(ref2.field(Fields.KReference_POINTER));
        final JJITExpressionImpl eq2 = ref.field(Fields.KReference_SEGMENT).eq(ref2.field(Fields.KReference_SEGMENT));
        return eq1.and(eq2);
    }
    ...
    private static class Single extends JJITInstructionSingle implements Cloneable {
        ...
        private Single(JJIT__BASE_IF_A d, int label, IntHashMap labels) {
            super(d);
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            KReference value2 = frame.popRef();
