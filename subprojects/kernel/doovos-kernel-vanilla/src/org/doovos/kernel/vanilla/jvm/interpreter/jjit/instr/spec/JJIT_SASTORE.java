...
public final class JJIT_SASTORE extends JJIT__BASE_XASTORE {
    public static final JJIT_SASTORE INSTANCE = new JJIT_SASTORE();
    private JJIT_SASTORE() {
        super(KOperator.IASTORE,KRegisterType.INTEGER, Types.SHORT,Calls.MemoryManager_setShortArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            memoryManager.setShortArray(frame.popRef(), index, (short)val);
            return next;
        }
