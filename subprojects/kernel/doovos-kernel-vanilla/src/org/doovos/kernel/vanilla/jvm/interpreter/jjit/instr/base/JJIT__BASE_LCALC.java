...
public abstract class JJIT__BASE_LCALC extends JJITInstructionDef {

    private JJITMathOp calcOp;

    protected JJIT__BASE_LCALC(KOperator op, JJITMathOp calcOp) {
        super(op);
        this.calcOp = calcOp;
    }
...
//        return new JJITStackChange(new KRegisterType[]{KRegisterType.LONG,KRegisterType.LONG}, new KRegisterType[]{KRegisterType.LONG});
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        final JJITName v2 = r.declareLocalVar(Types.LONG, "l", null);
        r.set(v2, r.popLong());
    ...
    public boolean equals(Object obj) {
        ...
        final JJIT__BASE_LCALC other = (JJIT__BASE_LCALC) obj;
