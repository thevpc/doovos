 ...
 */
public final class JJIT_INVOKEINTERFACE extends JJIT__BASE_INVOKE {

    public JJIT_INVOKEINTERFACE(Object[] constants,int classNameIndex, int methodNameIndex) {
        super(KOperator.INVOKEINTERFACE, constants, classNameIndex, methodNameIndex);
    }
