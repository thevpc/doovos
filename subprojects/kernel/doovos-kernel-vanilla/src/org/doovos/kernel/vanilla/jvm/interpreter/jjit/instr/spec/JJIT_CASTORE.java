...
public final class JJIT_CASTORE extends JJIT__BASE_XASTORE {
    public static final JJIT_CASTORE INSTANCE = new JJIT_CASTORE();

    private JJIT_CASTORE() {
        super(KOperator.CASTORE, KRegisterType.INTEGER, Types.CHAR, Calls.MemoryManager_setCharArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            memoryManager.setCharArray(frame.popRef(), index, (char) val);
            return next;
        }
