...
public final class JJIT_LALOAD extends JJIT__BASE_XALOAD{
    public static final JJIT_LALOAD INSTANCE = new JJIT_LALOAD();

    private JJIT_LALOAD() {
        super(KOperator.LALOAD, Types.KLONG,Calls.MemoryManager_getLongArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            frame.push(new KLong(memoryManager.getLongArray(frame.popRef(), index)));
            return next;
        }
