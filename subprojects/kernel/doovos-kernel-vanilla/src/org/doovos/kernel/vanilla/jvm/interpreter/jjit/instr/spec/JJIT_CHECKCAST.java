 ...
 * @author vpc
 */
public final class JJIT_CHECKCAST extends JJITInstructionDef {

    public static final JJIT_CHECKCAST INSTANCE = new JJIT_CHECKCAST();

    private JJIT_CHECKCAST() {
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        return new JJITChanges(JJITChangeOp.POP_REF, JJITChangeOp.PUSH_REF);
    }
