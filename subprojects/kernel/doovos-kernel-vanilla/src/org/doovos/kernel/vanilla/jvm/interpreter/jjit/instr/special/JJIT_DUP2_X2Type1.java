 ...
 */
public final class JJIT_DUP2_X2Type1 extends JJITInstructionDef {

    public static final JJIT_DUP2_X2Type1 INSTANCE = new JJIT_DUP2_X2Type1();

    private JJIT_DUP2_X2Type1() {
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        final JJITName r4 = r.declareLocalVar(Types.KREGISTER, "r", null);
        r.pop(r1);
        r.pop(r2);
        r.pop(r3);
        r.pop(r4);
        r.push(r2,r1,r4,r3,r2,r1);
    }
