 ...
 * ====================================================================
 */
public final class JJIT_CALOAD extends JJIT__BASE_XALOAD {

    public static final JJIT_CALOAD INSTANCE = new JJIT_CALOAD();

    private JJIT_CALOAD() {
        super(KOperator.CALOAD, Types.KINTEGER, Calls.MemoryManager_getCharArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            frame.push(new KInteger(memoryManager.getCharArray(frame.popRef(), index)));
            return next;
        }
