...
public abstract class JJIT__BASE_ICALC extends JJITInstructionDef {

    private JJITMathOp calcOp;

    protected JJIT__BASE_ICALC(KOperator op, JJITMathOp calcOp) {
        super(op);
        this.calcOp = calcOp;
    }
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        final JJITName v2 = r.declareIndex();
        r.popInt(v2);
        r.push(new JJITNew(Types.KINTEGER, r.popInt().calc(calcOp, v2)));
    }

    @Override
    public JJITChanges getChanges(JJITChangeModel model) {
        //return new JJITStackChange(new KRegisterType[]{KRegisterType.INTEGER, KRegisterType.INTEGER}, new KRegisterType[]{KRegisterType.INTEGER});
    ...
    public boolean equals(Object obj) {
        ...
        final JJIT__BASE_ICALC other = (JJIT__BASE_ICALC) obj;
    ...
    public int hashCode() {
        int hash = 5;
        hash = 31 * hash + (this.calcOp != null ? this.calcOp.hashCode() : 0);
        return hash;
    }
