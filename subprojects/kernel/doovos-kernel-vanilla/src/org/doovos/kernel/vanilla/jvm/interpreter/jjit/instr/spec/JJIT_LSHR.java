...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_LCALC;
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.base.JJIT__BASE_LSHX;
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.src.JJITMathOp;

public final class JJIT_LSHR extends JJIT__BASE_LSHX {

    public static final JJIT_LSHR INSTANCE = new JJIT_LSHR();

    private JJIT_LSHR() {
        super(KOperator.LSHR, JJITMathOp.SHR);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable{
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            int b = frame.popInt();
            frame.push(new KLong(frame.popLong() >> b));
            return next;
        }
    }
}
