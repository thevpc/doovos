...
//
//public final class KJVM_LALOAD_1 extends KInstructionLnk implements Cloneable {
//    public static final KJVM_LALOAD INSTANCE = new KJVM_LALOAD();
//    
//
//    private KJVM_LALOAD_1() {
//        super(KOperator.LALOAD);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        int index = frame.popInt();
//        KReference ref = frame.popReference();
//        frame.push(new KLong(Doovos.getSystem().getMemoryManager().getLongArray(ref, index)));
...
//                        "        " + jitContext.pushConsumed("new KLong(memoryManager.getLongArray(ref, index))")
//                        + "\n    }"
//                , null, null, null
//        );
//    }
