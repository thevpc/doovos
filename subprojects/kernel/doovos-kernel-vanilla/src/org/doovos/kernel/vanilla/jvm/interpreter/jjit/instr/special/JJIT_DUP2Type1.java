...
public final class JJIT_DUP2Type1 extends JJITInstructionDef {

    public static final JJIT_DUP2Type1 INSTANCE = new JJIT_DUP2Type1();

    private JJIT_DUP2Type1() {
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        ...
        return new JJITChanges(JJITChangeOp.Pop(t1), JJITChangeOp.Pop(t2), JJITChangeOp.Push(t2), JJITChangeOp.Push(t1), JJITChangeOp.Push(t2), JJITChangeOp.Push(t1));
    }
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        final JJITName r2 = r.declareReg2();
        r.popReg(r1);
        r.peek(r2,3);
        r.push(r1,r2,r1);
    }
