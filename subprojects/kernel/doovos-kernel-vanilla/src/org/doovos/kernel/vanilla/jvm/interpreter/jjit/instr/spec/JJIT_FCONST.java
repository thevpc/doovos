...
public final class JJIT_FCONST extends JJITInstructionDef {

    public static final JJIT_FCONST FCONST_0 = new JJIT_FCONST(KOperator.FCONST_0,KFloat.ZERO);
    public static final JJIT_FCONST FCONST_1 = new JJIT_FCONST(KOperator.FCONST_1, KFloat.ONE);
    public static final JJIT_FCONST FCONST_2 = new JJIT_FCONST(KOperator.FCONST_2, KFloat.TWO);
    private KFloat value;

    private JJIT_FCONST(KOperator operator, KFloat value) {
        super(operator);
        this.value = value;
    }
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        return new JJITChanges(JJITChangeOp.PUSH_FLOAT);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        private KFloat CONST;
        private Single(JJIT_FCONST d) {
            super(d);
            CONST=d.value;
        }
    ...
    public boolean equals(Object o) {
        ...
        JJIT_FCONST that = (JJIT_FCONST) o;
