...
public final class JJIT_INVOKESPECIAL extends JJIT__BASE_INVOKE {

    public JJIT_INVOKESPECIAL(Object[] constants, int classNameIndex, int methodNameIndex) {
        super(KOperator.INVOKESPECIAL, constants, classNameIndex, methodNameIndex);
    }
    ...
    private static class Single extends JJITInstructionSingle implements Cloneable {
        ...
        private int nextpc;
        private transient KMethod implMethod;
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            if (implMethod == null) {
                implMethod = frame.getClassRepository().getClassByName(classNameString).getMethodBySignature(methodNameString);
                ignorable=implMethod.isIgnorable();
            }
            if (ignorable) {
