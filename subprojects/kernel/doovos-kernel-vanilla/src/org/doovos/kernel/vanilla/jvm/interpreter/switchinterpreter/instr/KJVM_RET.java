...
// */
//public final class KJVM_RET extends KInstructionSwitch implements Cloneable, KInstructionJump {
...
//        return frame.getMethod().getCode()[value.value];
//    }
//
...
////                ,String.valueOf(localIndex), "next", new String[]{
////                        "this.next=code["+ localIndex +"]"
////                }
////        );
//    }
//
