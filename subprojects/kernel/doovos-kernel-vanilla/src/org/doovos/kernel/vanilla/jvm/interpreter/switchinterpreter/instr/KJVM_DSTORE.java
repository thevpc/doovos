...
// */
//public final class KJVM_DSTORE extends KInstructionSwitch implements Cloneable, KInstructionStore {
//    public static final KJVM_DSTORE DSTORE_0 = new KJVM_DSTORE(KOperator.DSTORE_0, 0);
//    public static final KJVM_DSTORE DSTORE_1 = new KJVM_DSTORE(KOperator.DSTORE_1, 1);
//    public static final KJVM_DSTORE DSTORE_2 = new KJVM_DSTORE(KOperator.DSTORE_2, 2);
//    public static final KJVM_DSTORE DSTORE_3 = new KJVM_DSTORE(KOperator.DSTORE_3, 3);
//
//    private int index;
//    protected KInstruction next;
//
//    private KJVM_DSTORE(KOperator op, int index) {
//        super(op);
//        this.index = index;
//    }
//
//    public KJVM_DSTORE(long[] operands) {
...
//
//        KJVM_DSTORE that = (KJVM_DSTORE) o;
//
