...
public class KJVM_CRETURNDump implements Opcodes {
    ...
    public byte[] dump() throws Exception {
        ...
        cw.visit(V1_6, ACC_PUBLIC + ACC_FINAL, "KJVM_CRETURN", null, "org/doovos/kernel/vanilla/jvm/interpreter/linkerinterpreter/KInstructionLnk", new String[]{"java/lang/Cloneable", "org/doovos/kernel/core/jvm/interpreter/instr/groups/KInstructionReturn"});

        {
            fv = cw.visitField(ACC_PUBLIC + ACC_FINAL + ACC_STATIC, "INSTANCE", "LKJVM_CRETURN;", null, null);
            fv.visitEnd();
        }
        {
            ...
            mv.visitFieldInsn(GETSTATIC, "org/doovos/kernel/api/jvm/bytecode/KOperator", "CRETURN", "Lorg/doovos/kernel/api/jvm/bytecode/KOperator;");
        ...
        }
        {
            ...
            mv.visitFieldInsn(PUTFIELD, "KJVM_CRETURN", "ordinal", "I");
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 4);
            mv.visitEnd();
        }
        ...
        }
        {
            ...
            mv.visitCode();
            mv.visitTypeInsn(NEW, "KJVM_CRETURN");
            mv.visitInsn(DUP);
            mv.visitMethodInsn(INVOKESPECIAL, "KJVM_CRETURN", "<init>", "()V");
            mv.visitFieldInsn(PUTSTATIC, "KJVM_CRETURN", "INSTANCE", "LKJVM_CRETURN;");
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 0);
            mv.visitEnd();
        }
