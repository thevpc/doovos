 ...
 * ====================================================================
 */
public abstract class JJIT__BASE_IF_0 extends JJITInstructionDef /*KJVM__IF*/ {

    protected int label;
    private JJITCmpOp jop;

    public JJIT__BASE_IF_0(KOperator op, JJITCmpOp jop, int label) {
        super(op);
        this.label = label;
        this.jop = jop;
    }
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        //return new JJITStackChange(new KRegisterType[]{KRegisterType.INTEGER}, null);
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        r.popInt(index);
        r.set(jump, index.cmp(jop, JJITConstant.I0));
        r.Return(new JJITOp3(jump, lab, next));
        //this.next=instructions[index+1]:null
        final JJITMethodSourceInit init = cls.init();
    ...
    public boolean equals(Object obj) {
        ...
        final JJIT__BASE_IF_0 other = (JJIT__BASE_IF_0) obj;
