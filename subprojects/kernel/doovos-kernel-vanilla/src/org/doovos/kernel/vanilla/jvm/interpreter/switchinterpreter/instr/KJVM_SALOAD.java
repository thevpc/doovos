...
//
//public final class KJVM_SALOAD extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_SALOAD INSTANCE = new KJVM_SALOAD();
//    protected KInstruction next;
//
//    private KJVM_SALOAD() {
//        super(KOperator.SALOAD);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        int index = frame.popInt();
//        KReference ref = frame.popReference();
//        frame.push(new KShort(Doovos.getSystem().getMemoryManager().getShortArray(ref, index)));
...
//                        "        context.push(new KShort(Doovos.getSystem().getMemoryManager().getShortArray(ref, index)));"
//                        + "\n    }"
//                , null, null, null
//        );
//    }
