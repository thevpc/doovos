...
// */
//public final class KJVM_SASTORE extends KInstructionSwitch implements Cloneable, KInstructionStore {
//    public static final KJVM_SASTORE INSTANCE = new KJVM_SASTORE();
//    protected KInstruction next;
//
//    private KJVM_SASTORE() {
//        super(KOperator.SASTORE);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        short value = frame.popShort();
//        int index = frame.popInt();
//        KReference ref = frame.popReference();
//        Doovos.getSystem().getMemoryManager().setShortArray(ref, index, value);
...
//                },
//                "    {\n"
//                        + "       short value = " + jitContext.popShort() + ";\n" +
//                        "       int index = " + jitContext.popInt() + ";\n" +
//                        "       KReference ref = " + jitContext.popReference() + ";\n" +
//                        "       memoryManager.setShortArray(ref, index, value);\n"
//                        + "    }"
//                , null, null, null
//        );
//    }
