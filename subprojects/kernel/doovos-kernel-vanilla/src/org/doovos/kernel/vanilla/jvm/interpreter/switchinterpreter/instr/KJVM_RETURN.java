...
//
//public final class KJVM_RETURN extends KInstructionSwitch implements Cloneable, KInstructionReturn {
//    public static final KJVM_RETURN INSTANCE = new KJVM_RETURN();
//
//    private KJVM_RETURN() {
//        super(KOperator.RETURN);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        //**LOG**//log(i.operator, context, "");
//        return frame.popFrame().getCurrentInstructionIndex();
//    }
//
//    public KInstruction runDirect(KFrame frame) throws RemoteException {
//        //**LOG**//log(i.operator, context, "");
//        return frame.popFrame().getCurrentInstruction();
//    }
//
...
//                null, null,
//                "",
//                "context.popContext().getCurrentStatementIndex()", "context.popContext().getInstruction()", null
//
//        );
//    }
//
