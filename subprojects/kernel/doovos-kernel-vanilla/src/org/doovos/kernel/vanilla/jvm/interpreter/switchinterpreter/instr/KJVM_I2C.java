...
// */
//public final class KJVM_I2C extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_I2C INSTANCE = new KJVM_I2C();
...
//        frame.push(new KInteger((char) value));
...
//                null,
//                null, null,
//                "    " + jitContext.pushConsumed("new KInteger((char)(" + jitContext.popInt() + "))")
//                , null, null, null
//        );
//    }
//
