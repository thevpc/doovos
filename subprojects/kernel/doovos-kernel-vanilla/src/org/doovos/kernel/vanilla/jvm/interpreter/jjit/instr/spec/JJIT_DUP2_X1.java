...
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.special.JJIT_DUP2_X1Type1;
import org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.special.JJIT_DUP2_X1Type2;
...
public final class JJIT_DUP2_X1 extends JJITInstructionDef {

    public static final JJIT_DUP2_X1 INSTANCE = new JJIT_DUP2_X1();

    private JJIT_DUP2_X1() {
        super(KOperator.DUP2_X1);
    }
    ...
    public JJITChanges getChanges(JJITChangeModel model) {
        ...
        if (t1.isType2()) {
            return new JJITChanges(
                    ...
                    JJITChangeOp.Push(t1),
                    JJITChangeOp.Push(t2),
                    JJITChangeOp.Push(t1));
        } else {
            KRegisterType t3 = model.peek(2);
            return new JJITChanges(
                    JJITChangeOp.Pop(t1), JJITChangeOp.Pop(t2), JJITChangeOp.Pop(t3),
                    JJITChangeOp.Push(t2), JJITChangeOp.Push(t1), JJITChangeOp.Push(t3), JJITChangeOp.Push(t2), JJITChangeOp.Push(t1)
            );
        }
    }
    ...
    public JJITInstructionDef transform(JJITTransformerContext context) {
        ...
        if (context.getNode().getChanges().get(0).getRegisterType().isType2()) {
            return JJIT_DUP2_X1Type2.INSTANCE;
        } else {
            return JJIT_DUP2_X1Type1.INSTANCE;
        }
    }
