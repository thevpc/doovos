...
// */
//public final class KJVM_PUTSTATIC extends KInstructionSwitch implements Cloneable {
...
//        super(KOperator.PUTSTATIC, operands);
...
//        }
//        classByName.getField(attributeString, true).setStaticValue(frame.pop());
...
//            fieldByName = classByName.getField(attributeString, true);
//            if (frame.pushClassInitializerFrame(classByName)) {
//                KJVM_PUTSTATIC base2 = (KJVM_PUTSTATIC) base;
