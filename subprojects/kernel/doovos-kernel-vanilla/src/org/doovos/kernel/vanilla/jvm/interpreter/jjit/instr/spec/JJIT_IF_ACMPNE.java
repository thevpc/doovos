...
public final class JJIT_IF_ACMPNE extends JJIT__BASE_IF_A {
    public JJIT_IF_ACMPNE(int label) {
        super(KOperator.IF_ACMPNE, label);
    }

    @Override
    protected JJITExpression cmp(JJITName ref, JJITName ref2) {
        final JJITExpressionImpl eq1 = ref.field(Fields.KReference_POINTER).ne(ref2.field(Fields.KReference_POINTER));
        final JJITExpressionImpl eq2 = ref.field(Fields.KReference_SEGMENT).ne(ref2.field(Fields.KReference_SEGMENT));
        return eq1.or(eq2);
    }
