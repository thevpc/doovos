 ...
 */
public interface KInstructionJIT extends KInstruction {
    public static final int[] NO_LABELS = new int[0];
    ...
    /**
     * true if this instruction is a jump instruction (may performs a goto/jnp)
     *
     * @return
