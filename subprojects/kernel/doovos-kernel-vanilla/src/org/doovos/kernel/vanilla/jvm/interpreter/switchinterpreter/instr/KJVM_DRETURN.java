...
// */
//public final class KJVM_DRETURN extends KInstructionSwitch implements Cloneable, KInstructionReturn {
//    public static final KJVM_DRETURN INSTANCE = new KJVM_DRETURN();
//
//    private KJVM_DRETURN() {
//        super(KOperator.DRETURN);
//    }
//
//    public int run(KFrame context) throws RemoteException {
//        KFrame c = context;
//        KRegister value = c.pop();
//        context = context.popFrame();
//        context.push(value);
//        return KProcess.NEXT_STATEMENT;
//    }
//
//    public KInstruction runDirect(KFrame context) throws RemoteException {
//        KRegister value = context.pop();
//        context = context.popFrame();
//        context.push(value);
//        return context.getCurrentInstruction();
//    }
//
...
//                        + "\n    }",
//                null, "context.getInstruction()", null
//
//        );
//    }
//
