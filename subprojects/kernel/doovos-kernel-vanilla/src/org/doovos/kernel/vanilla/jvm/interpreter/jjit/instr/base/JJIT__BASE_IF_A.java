 ...
 * ====================================================================
 */
public abstract class JJIT__BASE_IF_A extends JJITInstructionDef /*KJVM__IF*/ {

    protected int label;

    public JJIT__BASE_IF_A(KOperator op, int label) {
        super(op);
        this.label = label;
    }
...
//        return new JJITStackChange(new KRegisterType[]{KRegisterType.REF,KRegisterType.REF}, null);
    ...
    public void visitImpl(JJITClassSource cls, JJITFlowControlNode node, int relativeIndex) {
        ...
        JJITName ref2 = r.declareRef2();
        JJITName jump = r.declareJump();
        r.popRef(ref);
        r.popRef(ref2);

        r.set(jump, cmp(ref, ref2));
    ...
    protected abstract JJITExpression cmp(JJITName ref, JJITName ref2);
    ...
    public boolean equals(Object obj) {
        ...
        final JJIT__BASE_IF_A other = (JJIT__BASE_IF_A) obj;
