...
public final class JJIT_DASTORE extends JJIT__BASE_XASTORE {
    public static final JJIT_DASTORE INSTANCE = new JJIT_DASTORE();

    private JJIT_DASTORE() {
        super(KOperator.DASTORE, KRegisterType.DOUBLE, null, Calls.MemoryManager_setDoubleArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            memoryManager.setDoubleArray(frame.popRef(), index, val);
            return next;
        }
