...
public class JJIT_RETURN extends JJITInstructionDef{

    public static final JJIT_RETURN INSTANCE = new JJIT_RETURN();

    protected JJIT_RETURN() {
