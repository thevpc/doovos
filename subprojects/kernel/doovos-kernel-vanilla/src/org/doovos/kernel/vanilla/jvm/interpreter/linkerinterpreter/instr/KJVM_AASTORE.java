...
// */
//public final class KJVM_AASTORE extends KInstructionLnk implements Cloneable, KInstructionArray, KInstructionStore {
//    public static final KJVM_AASTORE INSTANCE = new KJVM_AASTORE();
//
//    public KJVM_AASTORE() {
//        super(KOperator.AASTORE);
//    }
//
//     public KInstructionLnk run(KFrame frame) throws RemoteException {
//        KReference value = frame.popReference();
