...
import static org.doovos.kernel.vanilla.jvm.interpreter.jjit.instr.JJITChangeOp.PUSH_FLOAT;
 ...
 */
public final class JJIT_L2F extends JJIT__BASE_X2X {

    public static final JJIT_L2F INSTANCE = new JJIT_L2F();
    ...
    public JJITInstruction createSingleInstruction(Object[] constantDefs, IntHashMap labels) {
        return new JJITInstructionSingle() {
            ...
            public JJITInstruction run(KFrame frame) throws Exception {
                frame.push(new KFloat((float) frame.popLong()));
                return next;
            }
        };
    }
