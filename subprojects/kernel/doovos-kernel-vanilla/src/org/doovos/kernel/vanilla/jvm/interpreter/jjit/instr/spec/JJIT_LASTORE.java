...
public final class JJIT_LASTORE extends JJIT__BASE_XASTORE {
    public static final JJIT_LASTORE INSTANCE = new JJIT_LASTORE();
    private JJIT_LASTORE() {
        super(KOperator.LASTORE,KRegisterType.LONG,null,Calls.MemoryManager_setLongArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            memoryManager.setLongArray(frame.popRef(), index, val);
            return next;
        }
