...
// */
//public final class KJVM_FLOAD extends KInstructionSwitch implements Cloneable, KInstructionLoad {
//    private int index;
//    protected KInstruction next;
//
//    public static final KJVM_FLOAD FLOAD_0 = new KJVM_FLOAD(KOperator.FLOAD_0, 0);
//    public static final KJVM_FLOAD FLOAD_1 = new KJVM_FLOAD(KOperator.FLOAD_1, 1);
//    public static final KJVM_FLOAD FLOAD_2 = new KJVM_FLOAD(KOperator.FLOAD_2, 2);
//    public static final KJVM_FLOAD FLOAD_3 = new KJVM_FLOAD(KOperator.FLOAD_3, 3);
//
//    private KJVM_FLOAD(KOperator op, int value) {
//        super(op);
//        this.index = value;
//    }
//
//    public KJVM_FLOAD(long[] operands) {
//        super(KOperator.FLOAD, operands);
...
//                null,
//                null, null,
//                "        context.push(context.getLocal(" + index + "));"
//                , null, null, null
//        );
//    }
//
