...
//
//public final class KJVM_ILOAD extends KInstructionSwitch implements Cloneable, KInstructionLoad {
//    private int index;
//    public static final KJVM_ILOAD ILOAD_0 = new KJVM_ILOAD(KOperator.ILOAD_0, 0);
//    public static final KJVM_ILOAD ILOAD_1 = new KJVM_ILOAD(KOperator.ILOAD_1, 1);
//    public static final KJVM_ILOAD ILOAD_2 = new KJVM_ILOAD(KOperator.ILOAD_2, 2);
//    public static final KJVM_ILOAD ILOAD_3 = new KJVM_ILOAD(KOperator.ILOAD_3, 3);
//    protected KInstruction next;
//
//    private KJVM_ILOAD(KOperator op, int value) {
//        super(op);
//        this.index = value;
//    }
//
//    public KJVM_ILOAD(long[] operands) {
//        super(KOperator.ILOAD, operands);
...
//        //**LOG**//log(i.operator, context, "local=" + this.operands[0] + " , value=" + value);
//        frame.push(frame.getLocal(index));
...
//        code.line(jitContext.pushConsumed("context.getLocal(" + index + ")"));
