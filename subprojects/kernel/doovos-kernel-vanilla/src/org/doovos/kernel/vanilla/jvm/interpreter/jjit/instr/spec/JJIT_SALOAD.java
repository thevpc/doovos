 ...
 * ====================================================================
 */
public final class JJIT_SALOAD extends JJIT__BASE_XALOAD {

    public static final JJIT_SALOAD INSTANCE = new JJIT_SALOAD();

    private JJIT_SALOAD() {
        super(KOperator.SALOAD, Types.KINTEGER, Calls.MemoryManager_getShortArray);
    }
