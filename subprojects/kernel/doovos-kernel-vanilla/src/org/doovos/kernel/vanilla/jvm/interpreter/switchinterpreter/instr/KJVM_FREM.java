...
//
//public final class KJVM_FREM extends KInstructionSwitch implements Cloneable {
//    public static final KJVM_FREM INSTANCE = new KJVM_FREM();
//    protected KInstruction next;
//
//    private KJVM_FREM() {
//        super(KOperator.FREM);
//    }
//
//    public int run(KFrame frame) throws RemoteException {
//        float b = frame.popFloat();
//        float a = frame.popFloat();
//        frame.push(new KFloat(a % b));
...
//                null, null,
//                "    {\n"
//                        + "       float b = " + jitContext.popFloat() + ";\n" +
//                        "       float a = " + jitContext.popFloat() + ";\n" +
//                        "       " + jitContext.pushConsumed("new KFloat(a % b)")
//                        + "    }"
//                , null, null, null
//        );
//    }
