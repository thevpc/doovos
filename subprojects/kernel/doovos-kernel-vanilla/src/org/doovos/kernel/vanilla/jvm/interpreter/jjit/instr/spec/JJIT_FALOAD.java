 ...
 * ====================================================================
 */
public final class JJIT_FALOAD extends JJIT__BASE_XALOAD {

    public static final JJIT_FALOAD INSTANCE = new JJIT_FALOAD();

    private JJIT_FALOAD() {
        super(KOperator.FALOAD, Types.KFLOAT, Calls.MemoryManager_getFloatArray);
    }
    ...
    private static class Single extends JJITInstructionSingleNext implements Cloneable {
        ...
        public JJITInstruction run(KFrame frame) throws Exception {
            ...
            frame.push(new KFloat(memoryManager.getFloatArray(frame.popRef(), index)));
            return next;
        }
