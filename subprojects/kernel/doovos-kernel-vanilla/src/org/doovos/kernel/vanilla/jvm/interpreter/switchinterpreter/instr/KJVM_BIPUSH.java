...
//
//public final class KJVM_BIPUSH extends KInstructionSwitch implements Cloneable {
//    private KInteger value;
//    protected KInstruction next;
//
//    public KJVM_BIPUSH(long[] operands) {
//        super(KOperator.BIPUSH, operands);
//        value = new KInteger((byte) operands[0]);
//    }
//
...
//        KInteger value = new KInteger((byte) i.getOperands()[0]);
//        frame.push(value);
//        return KProcess.NEXT_STATEMENT;
//    }
//
...
//
//        KJVM_BIPUSH that = (KJVM_BIPUSH) o;
//
