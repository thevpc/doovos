...
// */
//public final class KJVM_GETSTATIC extends KInstructionSwitch implements Cloneable {
...
//
//    public KJVM_GETSTATIC(long[] operands) {
//        super(KOperator.GETSTATIC, operands);
...
//        }
//        frame.push(classByName.getField(attributeString, true).getStaticValue());
...
//            }
//        }
//        KRegister value = fieldByName.getStaticValue();
//        if (value instanceof KReference) {
//            KReference r = (KReference) value;
//            if (!r.isNull() && r.segment != frame.getProcess().getMemorySegment().getId()) {
//                Doovos.syslog("????????");
//                value = fieldByName.getStaticValue();
//            }
//        }
//        frame.push(value);
//        return KProcess.NEXT_STATEMENT;
...
//            fieldByName = classByName.getField(attributeString, true);
//            if (frame.pushClassInitializerFrame(classByName)) {
//                KJVM_GETSTATIC base2 = (KJVM_GETSTATIC) base;
...
//
//        KJVM_GETSTATIC that = (KJVM_GETSTATIC) o;
//
...
//        if (classByName != null) {
//            return new KJVM_GETSTATIC0(classNameIndex, attributeIndex, fieldByName, classByName);
//        }
//        return super.clone();
//    }
//}
